...
Begin VB.Form frmHSSBillSettlingCashier 
   ...
   End
End
Attribute VB_Name = "frmHSSBillSettlingCashier"
...
Private Sub printBill(CompanyName As String, PatientName As String, BHT As String, PaymentValue As Double, BillNo As Long)
    ...
    If SelectForm(cmbPaper.Text, Me.hwnd) = 1 Then
        temBillPoints = PrintThisBill(CStr(BillNo), cmbPaymentMethod.Text, PatientName, Format(Date, "dd MM yyyy"), Format(Time, "hh:mm AMPM"), "Credit Settlement", "")
