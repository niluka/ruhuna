...
Begin VB.Form frmMTBillReprint 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Reprint of Medical Test Bills"
   ClientHeight    =   7575
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9825
   ...
   End
End
Attribute VB_Name = "frmMTBillReprint"
...
Private Sub printBill()
    ...
    If SelectForm(cmbPaper.Text, Me.hwnd) = 1 Then
        temBillPoints = PrintThisBill(txtDisplayBillID.Text, txtPM.Text, txtPt.Text, Format(Date, "dd MM yyyy"), Format(Time, "hh:mm AMPM"), "Medical Tests - Reprint", "")
...
'        MyFOnt.Bold = False
'        MyFOnt.Size = 11
'        PrintingText 0, temY, Printer.Width, 0, "Medical Test Bill (Reprint)", CentreAlign, MyFOnt
'
'        MyFOnt.Size = 11
'
'        Printer.Print
...
'        temY = Printer.CurrentY
'        PrintingText FieldX, temY, ValueX, 0, "Payment Method : " & txtPM.Text, LeftAlign, MyFOnt
'        temY = Printer.CurrentY
...
'                    "WHERE tblIncomeBill.IncomeBillID = " & Val(txtBillID.Text)
        ...
        temSql = "SELECT tblIncomeBill.*, tblIncomeBill.IncomeBillID as IBIncomeBillID, tblIncomeBill.DisplayBillID, tblIncomeBill.CompletedTime as IBCompletedTime ,  tblIncomeBill.CompletedDate as IBCompletedDate , tblPatientMainDetails.FirstName, tblPaymentMethod.PaymentMethod as MyPM, tblIncomeBill.NetTotal, tblBookedUser.Name as BName, tblIncomeBill.Cancelled as IBCancelled, tblIncomeBill.CancelledDate as IBCancelledDate, tblIncomeBill.CancelledTime as IBCancelledTime, dbo.tblHealthSchemeSuppliers.HealthSchemeSupplierName " & _
                    "FROM         dbo.tblIncomeBill INNER JOIN " & _
                    "                      dbo.tblHealthSchemeSuppliers ON dbo.tblIncomeBill.HSSID = dbo.tblHealthSchemeSuppliers.HealthSchemeSupplierID  LEFT OUTER JOIN " & _
                      "                    dbo.tblPaymentMethod ON dbo.tblIncomeBill.PaymentMethodID = dbo.tblPaymentMethod.PaymentMethodID LEFT OUTER JOIN " & _
                       "                   dbo.tblStaff tblBookedUser ON dbo.tblIncomeBill.CompletedUserID = tblBookedUser.StaffID LEFT OUTER JOIN " & _
                        "                  dbo.tblStaff tblCancelledUser ON dbo.tblIncomeBill.CancelledUserID = tblCancelledUser.StaffID LEFT OUTER JOIN " & _
        ...
        If .RecordCount > 0 Then
            ...
            txtUser.Text = !BName
            If IsNull(!HealthSchemeSupplierName) = False Then
                txtCompany.Text = !HealthSchemeSupplierName
