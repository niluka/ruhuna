...
Begin VB.Form frmBHTSummery 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmBHTSummery.frx":0000
      ...
      TabPicture(1)   =   "frmBHTSummery.frx":001C
      Tab(1).ControlEnabled=   -1  'True
      Tab(1).Control(0)=   "lblAdditionalChargeF"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "lblBalF"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).Control(2)=   "Label22"
      Tab(1).Control(2).Enabled=   0   'False
      Tab(1).Control(3)=   "lblProfessionalChargesF"
      Tab(1).Control(3).Enabled=   0   'False
      Tab(1).Control(4)=   "lblNursingChargesF"
      Tab(1).Control(4).Enabled=   0   'False
      Tab(1).Control(5)=   "lblMaintainChargesF"
      Tab(1).Control(5).Enabled=   0   'False
      Tab(1).Control(6)=   "lblAdmissionFeeF"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "lblLinenChargeF"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "lblServiceChargeF"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "lblMedicineChargeF"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "lblRoomChargeF"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "lblBalanceF"
      Tab(1).Control(11).Enabled=   0   'False
      Tab(1).Control(12)=   "lblPaymentsF"
      Tab(1).Control(12).Enabled=   0   'False
      Tab(1).Control(13)=   "lblTotalChargeF"
      ...
      Tab(1).Control(25)=   "lblNetChargeF"
      Tab(1).Control(25).Enabled=   0   'False
      Tab(1).Control(26)=   "Label4"
      Tab(1).Control(26).Enabled=   0   'False
      Tab(1).Control(27)=   "SSTab3"
      Tab(1).Control(27).Enabled=   0   'False
      Tab(1).Control(28)=   "txtDiscountF"
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         TabHeight       =   520
         TabCaption(0)   =   "Rooms"
         TabPicture(0)   =   "frmBHTSummery.frx":00C4
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "gridRoom"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Medicines"
         TabPicture(1)   =   "frmBHTSummery.frx":00E0
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "gridMedicines"
         Tab(1).ControlCount=   1
         TabCaption(2)   =   "Services"
         TabPicture(2)   =   "frmBHTSummery.frx":00FC
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "gridService"
         Tab(2).ControlCount=   1
         TabCaption(3)   =   "Professional"
         TabPicture(3)   =   "frmBHTSummery.frx":0118
         Tab(3).ControlEnabled=   0   'False
         Tab(3).Control(0)=   "gridProfessional"
         Tab(3).ControlCount=   1
         TabCaption(4)   =   "Payments"
         TabPicture(4)   =   "frmBHTSummery.frx":0134
         Tab(4).ControlEnabled=   0   'False
   ...
   End
End
Attribute VB_Name = "frmBHTSummery"
