...
Private Sub btnPrint_Click()
    GridPrint gridService, "Services", "From " & Format(dtpFrom.Value, "dd MMMM yyyy") & " to " & Format(dtpTo.Value, "dd MMMM yyyy")
End Sub
...
Private Sub FillGrid()
    ...
    With rstem
        ...
        End If
        temSql = temSql & " ORder by ServiceCategory, ServiceSubCategory"
