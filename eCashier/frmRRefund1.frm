...
Begin VB.Form frmRRefund 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Roentgents Refunds"
   ClientHeight    =   7455
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   6990
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmRRefund1.frx":0000
      ...
      TabPicture(1)   =   "frmRRefund1.frx":001C
...
Private Sub printBill()
    ...
    If SelectForm(cmbPaper.Text, Me.hwnd) = 1 Then
        temBillPoints = PrintThisBill(txtBillID.Text, txtDetail.Text, cmbPaymentMethod.Text, Format(Date, "dd MM yyyy"), Format(Time, "hh:mm AMPM"), "Roentgents Refund", "")
...
Private Sub btnSearch_Click()
    ...
    With rsTem
        If .State = 1 Then .Close
        temSql = "SELECT tblIncomeBill.*, tblBHTPatientMainDetails.FirstName as BHTFirstName, tblBHT.BHT, tblPatientMainDetails.FirstName as OPDFirstName, tblPaymentMethod.PaymentMethod as MyPM, tblBookedUser.Name as BName, tblCancelledUser.Name as CName, tblRefundMethod.PaymentMethod as MyRPM " & _
                    ...
                    "WHERE IsRBill = 1 AND tblIncomeBill.DisplayBillID = " & Val(txtBillID.Text)
        ...
        If .RecordCount > 0 Then
            ...
            If IsNull(![OPDFirstName]) = False Then
                temText = "Patient : " & ![OPDFirstName]
            ...
            temText = temText & vbNewLine & "Bill Date : " & Format(![CompletedDate], "dd MMMM yyyy") & " "
            temText = temText & vbNewLine & "Bill Time : " & Format(!CompletedTime, "HH : MM (AMPM)") & " "
            temText = temText & vbNewLine & "Booked User : " & ![BName]
            temText = temText & vbNewLine & "Payment Method : " & ![MyPM]
            If !Cancelled = True Then
                temText = temText = temText & vbNewLine & "Cancelled at " & !CancelledTime & " on " & ![CancelledDate] & " by " & ![CName] & "(" & ![MyRPM] & ")"
