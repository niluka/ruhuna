...
Begin VB.Form frmBHTPaymentBookeepingSummery 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "BHT Payment Bookeeping Summmery"
   ClientHeight    =   10845
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   13230
   ...
   End
End
Attribute VB_Name = "frmBHTPaymentBookeepingSummery"
...
Private Sub FillDirectPayments()
    ...
    With rsTem
        ...
        temSql = "SELECT     TOP 100 PERCENT dbo.tblIncomeBill.IncomeBillID, dbo.tblIncomeBill.DisplayBillID, dbo.tblIncomeBill.NetTotal, dbo.tblIncomeBill.BHTID, dbo.tblPaymentMethod.PaymentMethod , dbo.tblIncomeBill.CompletedDate, dbo.tblIncomeBill.CompletedTime, dbo.tblIncomeBill.PaymentComments " & _
                    ...
                    "WHERE     (dbo.tblIncomeBill.IsInwardPaymentBill = 1) AND (dbo.tblIncomeBill.Completed = 1) AND (dbo.tblIncomeBill.Cancelled = 0) AND (dbo.tblIncomeBill.CompletedDate BETWEEN CONVERT(DATETIME, '" & Format(dtpFrom.Value, "dd MMMM yyyy") & "', 102) AND CONVERT(DATETIME, '" & Format(dtpTo.Value, "dd MMMM yyyy") & "', 102)) " & _
