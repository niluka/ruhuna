...
Begin VB.Form frmPaymentSummery 
   ...
   End
End
Attribute VB_Name = "frmPaymentSummery"
...
Private Function CatToPay(ByVal IncomeCategory As String) As Double
    ...
    With rsTem
        ...
        If IncomeCategory = "All" Then
            temSql = temSql & "WHERE tblProfessionalCharges.Date Between '" & Format(#1/1/2008#, "dd MMMM yyyy") & "' And '" & Format(dtpTo.Value, "dd MMMM yyyy") & "' AND tblProfessionalCharges.Cancelled = 0  AND tblProfessionalCharges.PaidCancelled = 0 "
        Else
