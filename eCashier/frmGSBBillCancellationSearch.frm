...
Begin VB.Form frmGSBBillCancellationSearch 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Green Sheet Bill Cancellation"
   ClientHeight    =   8625
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   10995
   ...
   Begin MSDataListLib.DataCombo cmbUser 
      ...
      Text            =   ""
   End
   Begin btButtonEx.ButtonEx btnToCancel 
      Height          =   495
      Left            =   8280
      TabIndex        =   8
      Top             =   8040
   ...
   End
End
Attribute VB_Name = "frmGSBBillCancellationSearch"
...
Private Sub btnToCancel_Click()
    Dim temBillID As Long
    temBillID = Val(gridBill.TextMatrix(gridBill.Row, 0))
    If temBillID <> 0 Then
        frmGSBBillCancellation.txtBillID.Text = temBillID
        frmGSBBillCancellation.Show
    Else
        MsgBox "Please select a Bill to cancel"
        gridBill.SetFocus
        Exit Sub
    End If
...
Private Sub gridBill_DblClick()
    ...
    If temBillID <> 0 Then
        frmGSBBillCancellation.txtBillID.Text = temBillID
        frmGSBBillCancellation.Show
        frmGSBBillCancellation.ZOrder 0
        frmGSBBillCancellation.Top = 0
        frmGSBBillCancellation.Left = 0
    End If
End Sub
