...
Begin VB.Form frmPharmacyBillDisplay 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Pharmacy Bill Display"
   ClientHeight    =   9375
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   13875
   ...
   End
End
Attribute VB_Name = "frmPharmacyBillDisplay"
...
'                    "WHERE (((tblSaleBill.SaleBillID)=" & TxSaleBillID & ")) "
        ...
        If .RecordCount > 0 Then
            If !Cancelled = True Then
                tr = MsgBox("This bill is a cancelled Bill.", vbCritical, "Cancelled")
'                Unload Me
'                Exit Sub
            ElseIf !Returned = True Then
                tr = MsgBox("Some items in this bill has been returned.", vbCritical, "Cancelled")
'                Unload Me
'                Exit Sub
            End If
