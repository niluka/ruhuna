...
Begin VB.Form frmMTServiceValues 
   ...
   End
End
Attribute VB_Name = "frmMTServiceValues"
...
Private Sub btnExcel_Click()
    GridToExcel gridService, "MedicalTest Services"
End Sub

Private Sub btnPrint_Click()
    Dim ThisReportFormat As PrintReport
    GetPrintDefaults ThisReportFormat
    GridPrint gridService, ThisReportFormat, "MedicalTest Services", "From " & Format(dtpFrom.Value, "dd MMMM yyyy") & " to " & Format(dtpTo.Value, "dd MMMM yyyy")
        Printer.EndDoc
...
Private Sub FillGrid()
    ...
    With rsTem
        ...
        temSql = temSql & " AND tblPatientService.Deleted = 0 AND tblPatientService.MedicalTestBillID <> 0 "
        ...
        End If
        temSql = temSql & " AND tblPatientService.MedicalTestBILLID <> 0 AND tblPatientService.Deleted = 0 "
