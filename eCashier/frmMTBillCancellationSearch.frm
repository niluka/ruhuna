...
Begin VB.Form frmMTBillCancellationSearch 
   ...
   End
End
Attribute VB_Name = "frmMTBillCancellationSearch"
...
Private Sub gridBill_DblClick()
    ...
    If temBillID <> 0 Then
        frmMTBillCancellation.txtBillID.Text = temBillID
        frmMTBillCancellation.Show
    End If
End Sub
