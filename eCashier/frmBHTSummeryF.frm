...
Begin VB.Form frmBHTSummeryF 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "BHT Summery F"
   ClientHeight    =   10440
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   13440
   ...
   ScaleHeight     =   10440
   ScaleWidth      =   13440
   Begin VB.TextBox txtBlankLines 
      Height          =   375
      Left            =   9960
      TabIndex        =   96
      Top             =   9960
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmBHTSummeryF.frx":0000
      ...
      TabPicture(1)   =   "frmBHTSummeryF.frx":001C
      ...
      Tab(1).Control(14)=   "lblHCf"
      Tab(1).Control(14).Enabled=   0   'False
      Tab(1).Control(15)=   "lblAdditionalChargeF"
      Tab(1).Control(15).Enabled=   0   'False
      Tab(1).Control(16)=   "lblProfessionalChargesF"
      Tab(1).Control(16).Enabled=   0   'False
      Tab(1).Control(17)=   "lblNursingChargesF"
      Tab(1).Control(17).Enabled=   0   'False
      Tab(1).Control(18)=   "lblMaintainChargesF"
      Tab(1).Control(18).Enabled=   0   'False
      Tab(1).Control(19)=   "lblAdmissionFeeF"
      Tab(1).Control(19).Enabled=   0   'False
      Tab(1).Control(20)=   "lblLinenChargeF"
      Tab(1).Control(20).Enabled=   0   'False
      Tab(1).Control(21)=   "lblServiceChargeF"
      Tab(1).Control(21).Enabled=   0   'False
      Tab(1).Control(22)=   "lblMedicineChargeF"
      Tab(1).Control(22).Enabled=   0   'False
      Tab(1).Control(23)=   "lblRoomChargeF"
      Tab(1).Control(23).Enabled=   0   'False
      Tab(1).Control(24)=   "lblBalanceF"
      Tab(1).Control(24).Enabled=   0   'False
      Tab(1).Control(25)=   "lblPaymentsF"
      Tab(1).Control(25).Enabled=   0   'False
      Tab(1).Control(26)=   "lblTotalChargeF"
      Tab(1).Control(26).Enabled=   0   'False
      Tab(1).Control(27)=   "lblNetChargeF"
      Tab(1).Control(27).Enabled=   0   'False
      Tab(1).Control(28)=   "lblHospitalBillF"
      Tab(1).Control(28).Enabled=   0   'False
      Tab(1).Control(29)=   "SSTab3"
      Tab(1).Control(29).Enabled=   0   'False
      Tab(1).Control(30)=   "txtDiscountF"
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         TabHeight       =   520
         TabCaption(0)   =   "Rooms"
         TabPicture(0)   =   "frmBHTSummeryF.frx":00C4
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "gridRoom"
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Medicines"
         TabPicture(1)   =   "frmBHTSummeryF.frx":00E0
         Tab(1).ControlEnabled=   -1  'True
         Tab(1).Control(0)=   "gridMedicines"
         Tab(1).Control(0).Enabled=   0   'False
         Tab(1).ControlCount=   1
         TabCaption(2)   =   "Services"
         TabPicture(2)   =   "frmBHTSummeryF.frx":00FC
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "gridService"
         Tab(2).ControlCount=   1
         TabCaption(3)   =   "Professional"
         TabPicture(3)   =   "frmBHTSummeryF.frx":0118
         Tab(3).ControlEnabled=   0   'False
         Tab(3).Control(0)=   "gridProfessional"
         Tab(3).ControlCount=   1
         TabCaption(4)   =   "Payments"
         TabPicture(4)   =   "frmBHTSummeryF.frx":0134
         Tab(4).ControlEnabled=   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   480
      Width           =   7335
      Begin btButtonEx.ButtonEx btnCreditLetter 
         Height          =   375
         Left            =   2400
         TabIndex        =   89
         Top             =   720
      ...
      Begin btButtonEx.ButtonEx btnOfficePrint 
         ...
         EndProperty
      End
      Begin btButtonEx.ButtonEx btnIntrimBill 
         Height          =   375
         Left            =   2400
         TabIndex        =   90
         Top             =   1200
   ...
   End
End
Attribute VB_Name = "frmBHTSummeryF"
...
Option Explicit
    ...
    Dim rsBHTView As New ADODB.Recordset
...
Private Sub btnCreditLetter_Click()
    If MyBHT.HealthSchemeSupplierID = 0 Then
        MsgBox "Only Credit Bills"
        Exit Sub
    End If
    btnProcess_Click
    
    Dim YourRef As String
    
    YourRef = InputBox("Please enter Your Referance No.")
    ...
    MyHSS.HSSID = MyBHT.HealthSchemeSupplierID
    
    
    myworksheet.Cells(29, 5) = lblBalanceF.Caption
    myworksheet.Cells(23, 6) = MyBHT.BHTID
    myworksheet.Cells(29, 5) = lblBalanceF.Caption
    myworksheet.Cells(25, 3) = MyBHT.FirstName
    myworksheet.Cells(16, 3) = YourRef
    
    
    AllLines = SeperateLines(MyHSS.Name & vbNewLine & MyHSS.Address)
    For i = 0 To UBound(AllLines) - 1
        myworksheet.Cells(10 + i, 2) = AllLines(i)
    Next
    
    If FSys.FileExists(FSys.GetParentFolderName(Database) & "\Credit Letter for BHT No. " & MyBHT.BHT & ".xls") = True Then
        FSys.DeleteFile (FSys.GetParentFolderName(Database) & "\Credit Letter for BHT No. " & MyBHT.BHT & ".xls"), True
    End If
    
    myworkbook.SaveAs FSys.GetParentFolderName(App.Path) & "\CreditLetter" & MyBHT.BHT & ".xls"
...
Private Sub btnDischarge_Click()
    ...
    With rsTem
        ...
        If .RecordCount > 0 Then
            ...
            !ICUNursingRate = InwardPtCh.ICUNursingRate
            !MaintainaceCashDiscountRate = InwardPtCh.MaintainaceCashDiscountRate
    ...
    UpdateCompanyBalance MyBHT.HealthSchemeSupplierID, lblBalanceF.Caption, False, True, False
...
Private Sub DischargeFromRoom()
    ...
    With rsTem
        ...
        If .RecordCount > 0 Then
            !ToDate = dtpDOD.Value
            !ToTime = Format(dtpDOD.Value, "dd MMMM yyyy") & " " & dtpTOD.Value
            .Update
        End If
        .Close
    End With
...
Private Sub FakeCalculations()
    ...
    If MyBHT.Discharge = True Then
        FPtAdmissionFee = MyBHT.AdmissionRate
        If MyBHT.Foreigner = True Then FPtAdmissionFee = FPtAdmissionFee * 2
        FPtRoomCharge = MyBHT.RoomCharge
        ...
        FHospitalBill = FPtAdmissionFee + FPtRoomCharge + FPtServiceCharge + FPtMedicineCharge + FPtLinanCharge + FPtNursingCharge + FPtMaintananceCharge
    ...
    lblHospitalBillF.Caption = Format(FHospitalBill, "0.00")
    ...
    If FPtBalance >= 0 Then
        lblBalF.Caption = "Balance Due"
        lblBalanceF.Caption = Format(Abs(FPtBalance), "0.00")
    Else
        lblBalF.Caption = "Balance Excess"
        lblBalanceF.Caption = Format(Abs(FPtBalance), "0.00")
    End If
...
Private Sub btnIntrimBill_Click()
    ...
    Dim pNo As Integer
    For pNo = 0 To Val(txtBlankLines.Text)
        Printer.Print
    Next
    ...
    If SelectForm(cmbPaper.Text, Me.hwnd) = 1 Then
        ...
        If (Val(txtBlankLines.Text)) <= 0 Then

        
            MyFOnt.Bold = True
            MyFOnt.Size = 13
            PrintingText 0, 1440 * 1, Printer.Width, 0, "RUHUNU HOSPITALS PVT(LTD)", CentreAlign, MyFOnt
            
            MyFOnt.Bold = False
            MyFOnt.Size = 12
            
            
            PrintingText 0, 1440 * 1, Printer.Width, 0, "Karapitiya, Galle", CentreAlign, MyFOnt
            PrintingText 0, 1440 * 1, Printer.Width, 0, "Tel. 091 2234059/60, Fax. 091 2234061", CentreAlign, MyFOnt
        ...
        PrintingText 0, temY, Printer.Width, 0, "INTRIM BILL - " & MyBHT.BHTID, CentreAlign, MyFOnt
...
'        PrintingText FieldX, temY, ValueX, 0, lblAdditionalChargeF.Caption, RightAlign, MyFOnt
        ...
        temY = Printer.CurrentY
        PrintingText FieldX, temY, CenterX, 0, "==========", rightAlign, MyFOnt
       
        temY = Printer.CurrentY
        PrintingText FieldX, temY, CenterX, 0, lblDis.Caption, leftAlign, MyFOnt
        PrintingText FieldX, temY, CenterX, 0, txtDiscountF.Text, rightAlign, MyFOnt
        
        
        
        temY = Printer.CurrentY
        PrintingText FieldX, temY, CenterX, 0, lblPay.Caption, leftAlign, MyFOnt
        PrintingText FieldX, temY, CenterX, 0, lblPaymentsF.Caption, rightAlign, MyFOnt
        ...
        For i = 0 To gridPaymentsF.Rows - 1
            temY = Printer.CurrentY
            PrintingText SubFieldX, temY, CenterX - 1440, 0, gridPaymentsF.TextMatrix(i, 1), leftAlign, MyFOnt
            PrintingText SubFieldX, temY, CenterX - 1440, 0, gridPaymentsF.TextMatrix(i, 2), rightAlign, MyFOnt
        Next
        ...
        temY = Printer.CurrentY
        PrintingText FieldX, temY, CenterX, 0, lblBal.Caption, leftAlign, MyFOnt
        PrintingText FieldX, temY, CenterX, 0, lblBalanceF.Caption, rightAlign, MyFOnt
        ...
        temY = Printer.CurrentY
        PrintingText FieldX, temY, ValueX, 0, "This Bill Does NOT include professional charges", leftAlign, MyFOnt
...
'        PrintingText 0, 0, Printer.Width, 0, HospitalAddress, CentreAlign, MyFOnt
        ...
        For i = 0 To UBound(AllLines) - 1
                If InStr(UCase(AllLines(i)), UCase("PAYMENT")) > 0 Then
                    DoEvents
                ElseIf InStr(UCase(AllLines(i)), UCase("AGE ")) > 0 Then
                    DoEvents
...
Private Sub btnPrint_ClickOld()
    ...
    If SelectForm(cmbPaper.Text, Me.hwnd) = 1 Then
        ...
        MyFOnt.Bold = True
        MyFOnt.Size = 13
        PrintingText 0, 1440 * 0.2, Printer.Width, 1440 * 0.2, "RUHUNU HOSPITAL PVT(LTD)", CentreAlign, MyFOnt
...
'        Printer.Print
        ...
        For i = 1 To gridRoomF.Rows - 1
            temY = Printer.CurrentY
            PrintingText SubFieldX, temY, SubValueX, 0, gridRoomF.TextMatrix(i, 0) & " - From " & gridRoomF.TextMatrix(i, 1) & " to " & gridRoomF.TextMatrix(i, 2) & " - " & gridRoomF.TextMatrix(i, 3), leftAlign, MyFOnt
            PrintingText SubFieldX, temY, SubValueX, 0, gridRoomF.TextMatrix(i, 4), rightAlign, MyFOnt
        Next
        ...
        If MyBHT.PaymentMethod = "Credit" Then
            If gridProfessional.Rows > 1 Then
...
'        PrintingText FieldX, temY, ValueX, 0, lblAdditionalChargeF.Caption, RightAlign, MyFOnt
        ...
        PrintingText FieldX, temY, ValueX, 0, lblTotalChargeF.Caption, rightAlign, MyFOnt
        temY = Printer.CurrentY
        PrintingText ValueX - Printer.TextWidth("=========="), temY, ValueX, 0, "==========", leftAlign, MyFOnt
        ...
        For i = 0 To gridPaymentsF.Rows - 1
            ...
            PrintingText SubFieldX, temY, CenterX - 1440, 0, "         ", leftAlign, MyFOnt
        ...
        temY = Printer.CurrentY
        PPTemY = temY
        PrintingText FieldX, temY, CenterX, 0, lblTot.Caption, leftAlign, MyFOnt
        PrintingText FieldX, temY, CenterX, 0, lblTotalChargeF.Caption, rightAlign, MyFOnt
        
        MyFOnt.Bold = True
        MyFOnt.Size = 12
        temY = Printer.CurrentY
        PrintingText CenterX - Printer.TextWidth("=========="), temY, CenterX, 0, "==========", leftAlign, MyFOnt
        temY = Printer.CurrentY
        PrintingText CenterX - Printer.TextWidth("=========="), PTemY, CenterX, 0, "==========", leftAlign, MyFOnt
        
        PrintingText FieldX, PPTemY, CenterX, 0, lblBal.Caption, leftAlign, MyFOnt
        PrintingText FieldX, PPTemY, CenterX, 0, lblBalanceF.Caption, rightAlign, MyFOnt
...
Private Sub btnPrint_ClickOld1()
    ...
    If SelectForm(cmbPaper.Text, Me.hwnd) = 1 Then
        ...
        MyFOnt.Bold = True
        MyFOnt.Size = 13
        PrintingText 0, 1440 * 0.2, Printer.Width, 1440 * 1, "RUHUNU HOSPITAL PVT(LTD)", CentreAlign, MyFOnt
...
'        PrintingText FieldX, temY, ValueX, 0, lblAdditionalChargeF.Caption, RightAlign, MyFOnt
        ...
        For i = 0 To gridPaymentsF.Rows - 1
            ...
            PrintingText SubFieldX, temY, SubValueX, 0, "         ", leftAlign, MyFOnt
        ...
        PrintingText ValueX - Printer.TextWidth("==============="), temY, ValueX, 0, "===============", leftAlign, MyFOnt
        temY = Printer.CurrentY
        PrintingText ValueX - Printer.TextWidth("==============="), PTemY, ValueX, 0, "===============", leftAlign, MyFOnt
        
        PrintingText FieldX, PPTemY, ValueX, 0, lblBal.Caption, leftAlign, MyFOnt
        PrintingText FieldX, PPTemY, ValueX, 0, lblBalanceF.Caption, rightAlign, MyFOnt
...
Public Sub btnProcess_Click()
    ...
    btnExcelOfficeCopy.Enabled = True
    btnExcelPatientCopy.Enabled = True
    ...
    If MyBHT.Discharge = True Then
        btnDischarge.Enabled = False
        btnIntrimBill.Enabled = False
    Else
        btnDischarge.Enabled = True
        btnIntrimBill.Enabled = True
    End If
    
    If MyBHT.PaymentMethod = "Credit" Then
        btnCreditLetter.Enabled = True
    End If
...
Private Function MaintananceCharges() As Double
    ...
    If MyBHT.Foreigner = True Then MaintananceCharges = MaintananceCharges * 2
End Function
...
'        .ColWidth(6) = 1200
    ...
    With rsTem
        ...
        temSql = "SELECT tblSpeciality.Speciality, tblTitle.Title, tblStaff.Name, tblProfessionalCharges.* " & _
                    ...
                    "WHERE (((tblProfessionalCharges.ProfessionalCharge)=1) AND ((tblProfessionalCharges.Cancelled)=0) AND ((tblProfessionalCharges.ForBHTID)=" & Val(cmbBHT.BoundText) & ")) " & _
                    "Order By tblProfessionalCharges.ProfessionalChargesID"
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        ...
        While .EOF = False
            ...
            gridProfessional.Text = Format(!Date, "dd MM yyyy")
...
'        .ColWidth(1) = .Width - .ColWidth(0) - 150
    ...
    With rsTem
        ...
        While .EOF = False
            ...
            If MyBHT.Foreigner = True Then
                If MyBHT.Discharge = False Then
                    gridService.Text = Format(!SumOfCharge * 2 * (100 + MyBHT.PtSurcharge) / 100, "0.00")
                    TotalFee = TotalFee + (!SumOfCharge * 2 * (100 + MyBHT.PtSurcharge) / 100)
                Else
                    gridService.Text = Format(!SumOfCharge * 2, "0.00")
                    TotalFee = TotalFee + !SumOfCharge * 2
                End If
            Else
                If MyBHT.Discharge = False Then
...
Private Function FillMedicines() As Double
    ...
    With rsBill
        ...
        While .EOF = False
            ...
            gridMedicines.Col = 0
            gridMedicines.Text = Format(!Date, "dd MM yyyy")
    ...
    With rsRoom
        ...
        While .EOF = False
            ...
            If DurationHours >= 1 Then
                ...
                gridRoom.Col = 1
                gridRoom.Text = Format(FromDate, "dd MM yy") & " - " & Format(FromTime, "HH:MM")
                
                gridRoom.Col = 2
                gridRoom.Text = Format(ToDate, "dd MM yy") & " - " & Format(ToTime, "HH:MM")
...
Private Function FMaintananceCharges() As Double
    ...
    If MyBHT.Foreigner = True Then
        FMaintananceCharges = FMaintananceCharges * 2
    End If
End Function
...
'        .ColWidth(6) = 1200
    ...
    With rsTem
        ...
        While .EOF = False
            ...
            gridProfessionalF.Text = Format(!Date, "dd MM yyyy")
...
Private Function FFillServices() As Double
    ...
    With rsTem
        ...
        While .EOF = False
            ...
            gridServiceF.Col = 0
            gridServiceF.Text = !ServiceCategory  '& " " & !ServiceSubcategory
            gridServiceF.Col = 1
            CatFee = !SumOfCharge
...
Private Function FFillMedicines() As Double
    ...
    With rsBill
        If .State = 1 Then .Close
        temSql = "SELECT tblSaleBill.Date, tblSaleBill.SaleBillID, tblSaleCategory.SaleCategory, tblSaleBill.NetPrice " & _
                    "FROM tblSaleBill INNER JOIN tblSaleCategory ON tblSaleBill.SaleCategoryID = tblSaleCategory.SaleCategoryID " & _
                    "WHERE (((tblSaleBill.BilledBHTID)=" & Val(cmbBHT.BoundText) & ")) Order by tblSaleBill.SaleBillID DESC"   '
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        While .EOF = False
            ...
            gridMedicinesF.Text = Format(!Date, "dd MM yyyy")
            ...
            gridMedicinesF.Col = 3
            gridMedicinesF.Text = !SaleBillID
        ...
        If .State = 1 Then .Close
        temSql = "SELECT tblReturnBill.Date, tblReturnBill.NetPrice, tblReturnBill.SaleBillID " & _
                    "From tblReturnBill " & _
                    "WHERE (((tblReturnBill.BilledBHTID)=" & Val(cmbBHT.BoundText) & "))"
    ...
    With rsRoom
        ...
        While .EOF = False
            ...
            If DurationHours >= 1 Then
                ...
                gridRoomF.Col = 1
                gridRoomF.Text = Format(FromDate, "dd MM yy") & " - " & Format(FromTime, "HH:MM")
                
                gridRoomF.Col = 2
                gridRoomF.Text = Format(ToDate, "dd MM yy") & " - " & Format(ToTime, "HH:MM")
...
Private Sub GetSettings(): On Error Resume Next
    ...
    txtBlankLines.Text = GetSetting(App.EXEName, Me.Name, txtBlankLines.Name, 0)
...
Private Sub SaveSettings()
    ...
    SaveSetting App.EXEName, Me.Name, txtBlankLines.Name, txtBlankLines.Text
...
Private Sub gridMedicinesF_DblClick()
            
            Dim temSaleBillID  As Long
            With gridMedicinesF
                TxSaleBillID = Val(.TextMatrix(.Row, 3))
            End With
            
            If TxSaleBillID <> 0 Then
                Unload frmPharmacyBillDisplay
                frmPharmacyBillDisplay.Show
                frmPharmacyBillDisplay.ZOrder 0
            Else
                temSaleBillID = Val(gridMedicinesF.TextMatrix(gridMedicinesF.Row, 4))
                If temSaleBillID <> 0 Then
                    Unload frmPharmacyReturnBillView
                    frmPharmacyReturnBillView.Show
                    frmPharmacyReturnBillView.txtID.Text = temSaleBillID
                End If
            End If
End Sub
...
Private Sub btnExcelOfficeCopy_Click()
    ...
    myworksheet.Cells(2, 1) = "BHT Summery - " & MyBHT.BHT
    ...
    myworksheet.Cells(16, 3) = txtDiscount.Text
    ...
    myworkbook.SaveAs FSys.GetParentFolderName(Database) & "BHT Summery - " & MyBHT.BHT & ".xls"
    
    myworkbook.Save
    
    ShellExecute 0&, "open", FSys.GetParentFolderName(Database) & "BHT Summery - " & MyBHT.BHT & ".xls", "", "", vbMaximizedFocus
