...
Begin VB.Form frmBHTSummeryFNoDischarge 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "BHT Summery F- ND"
   ClientHeight    =   10440
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   13440
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmBHTSummeryFNoDischarge.frx":0000
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "txtDiscount"
      Tab(0).Control(1)=   "SSTab2"
      Tab(0).Control(2)=   "Label6"
      Tab(0).Control(3)=   "lblNetCharge"
      Tab(0).Control(4)=   "lblDis"
      Tab(0).Control(5)=   "lblTot"
      Tab(0).Control(6)=   "lblTotalCharge"
      Tab(0).Control(7)=   "lblPayments"
      Tab(0).Control(8)=   "lblBalance"
      Tab(0).Control(9)=   "lblRoomCharge"
      Tab(0).Control(10)=   "lblMedicineCharge"
      Tab(0).Control(11)=   "lblServiceCharge"
      Tab(0).Control(12)=   "lblLinenCharge"
      Tab(0).Control(13)=   "lblAdmissionFee"
      Tab(0).Control(14)=   "lblMaintainCharges"
      Tab(0).Control(15)=   "lblNursingCharges"
      Tab(0).Control(16)=   "lblProfessionalCharges"
      Tab(0).Control(17)=   "lblR"
      Tab(0).Control(18)=   "lblM"
      Tab(0).Control(19)=   "lblS"
      Tab(0).Control(20)=   "lblL"
      Tab(0).Control(21)=   "lblA"
      Tab(0).Control(22)=   "lblPay"
      Tab(0).Control(23)=   "lblBal"
      Tab(0).Control(24)=   "lblMa"
      Tab(0).Control(25)=   "lblN"
      Tab(0).Control(26)=   "lblP"
      Tab(0).Control(27)=   "lblAdditionalCharge"
      Tab(0).Control(28)=   "lblAd"
      Tab(0).ControlCount=   29
      TabCaption(1)   =   "Patient Copy"
      TabPicture(1)   =   "frmBHTSummeryFNoDischarge.frx":001C
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         TabHeight       =   520
         TabCaption(0)   =   "Rooms"
         TabPicture(0)   =   "frmBHTSummeryFNoDischarge.frx":00C4
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "gridRoom"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Medicines"
         TabPicture(1)   =   "frmBHTSummeryFNoDischarge.frx":00E0
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "gridMedicines"
         Tab(1).ControlCount=   1
         TabCaption(2)   =   "Services"
         TabPicture(2)   =   "frmBHTSummeryFNoDischarge.frx":00FC
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "gridService"
         Tab(2).ControlCount=   1
         TabCaption(3)   =   "Professional"
         TabPicture(3)   =   "frmBHTSummeryFNoDischarge.frx":0118
         Tab(3).ControlEnabled=   0   'False
         Tab(3).Control(0)=   "gridProfessional"
         Tab(3).ControlCount=   1
         TabCaption(4)   =   "Payments"
         TabPicture(4)   =   "frmBHTSummeryFNoDischarge.frx":0134
         Tab(4).ControlEnabled=   0   'False
   ...
   End
End
Attribute VB_Name = "frmBHTSummeryFNoDischarge"
...
Private Sub btnCreditLetter_Click()
    ...
    TemPath = FSys.GetParentFolderName(Database) & "\rLetter.xls"
    ...
    myworkbook.SaveAs FSys.GetParentFolderName(App.EXEName) & "\CreditLetter" & MyBHT.BHT & ".xls"
...
Private Sub FillCombos()
    ...
    BHT.FillDblBoolComboNegPos cmbBHT, "BHT", "BHT", "IsBHT", 1, "Discharge", 0, False
End Sub
