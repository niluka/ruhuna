...
Begin VB.Form frmOPDBillCancellation 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cancellation of OPD Bills"
   ClientHeight    =   8175
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9825
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmOPDBillCancellation.frx":0000
      ...
      TabPicture(1)   =   "frmOPDBillCancellation.frx":001C
   ...
   End
End
Attribute VB_Name = "frmOPDBillCancellation"
...
Private Sub btnCancelBill_Click()
    ...
    frmOPDBillCancellationSearch.FormatGrid
    frmOPDBillCancellationSearch.FillGrid
...
Private Sub printBill()
    ...
    If SelectForm(cmbPaper.Text, Me.hwnd) = 1 Then
        ...
        temBillPoints = PrintThisBill(txtDisplayBillID.Text, cmbPaymentMethod.Text, txtPt.Text, Format(Date, "dd MM yyyy"), Format(Time, "hh:mm AMPM"), "OPD Services Bill Cancellation", "")
