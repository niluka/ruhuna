...
Begin VB.Form frmDailySummeryReport 
   ...
   End
End
Attribute VB_Name = "frmDailySummeryReport"
        ...
        While rsCat.EOF = False
            ...
            With rsTem
                ...
                temSql = "SELECT     SUM(dbo.tblPatientService.HospitalCharge) AS SumOfHospitalCharge, SUM(dbo.tblPatientService.ProfessionalCharge) AS SumOfProfessionalCharge, SUM(dbo.tblPatientService.Charge) AS SumOfCharge " & _
                            ...
                            "(dbo.tblIncomeBill.IsOPDBill = 1)  AND (dbo.tblIncomeBill.Cancelled = 1) AND (dbo.tblIncomeBill.PaymentMethodID <> 4) AND (dbo.tblPatientService.ServiceCategoryID = " & temCatID & ") "
                
                .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
                If .RecordCount > 0 Then
                    If IsNull(!SumOfHospitalCharge) = False Then
                        SubTotalH = SubTotalH - !SumOfHospitalCharge
                    End If
                    If IsNull(!SumOfProfessionalCharge) = False Then
                        SubTotalP = SubTotalP - !SumOfProfessionalCharge
                    End If
                    If IsNull(!SumOfCharge) = False Then
                        SubTotal = SubTotal - !SumOfCharge
                    End If
                End If
                .Close
            End With
            ...
            If SubTotal <> 0 Then
                    ...
                    While rsSC.EOF = False
                        ...
                        With rsTem
                            ...
                            temSql = "SELECT     SUM(dbo.tblPatientService.HospitalCharge) AS SumOfHospitalCharge, SUM(dbo.tblPatientService.ProfessionalCharge) AS SumOfProfessionalCharge, SUM(dbo.tblPatientService.Charge) AS SumOfCharge  " & _
                                        "FROM         dbo.tblIncomeBill RIGHT OUTER JOIN dbo.tblPatientService ON dbo.tblIncomeBill.IncomeBillID = dbo.tblPatientService.OPDBillID " & _
                                        "WHERE    (dbo.tblPatientService.Deleted = 0) AND    (dbo.tblIncomeBill.Completed = 1) AND (dbo.tblIncomeBill.CompletedDate = CONVERT(DATETIME, '" & Format(dtpDate.Value, "dd MMMM yyyy") & "', 102)) AND " & _
                                        "(dbo.tblIncomeBill.IsOPDBill = 1) AND (dbo.tblIncomeBill.PaymentMethodID <> 4) AND (dbo.tblPatientService.ServiceSubCategoryID = " & temSCID & ") "
                        ...
                        With rsTem
                            ...
                            temSql = "SELECT     SUM(dbo.tblPatientService.HospitalCharge) AS SumOfHospitalCharge, SUM(dbo.tblPatientService.ProfessionalCharge) AS SumOfProfessionalCharge, SUM(dbo.tblPatientService.Charge) AS SumOfCharge  " & _
                                        "FROM         dbo.tblIncomeBill RIGHT OUTER JOIN dbo.tblPatientService ON dbo.tblIncomeBill.IncomeBillID = dbo.tblPatientService.OPDBillID " & _
                                        "WHERE    (dbo.tblPatientService.Deleted = 0) AND    (dbo.tblIncomeBill.Completed = 1) AND (dbo.tblIncomeBill.CancelledDate = CONVERT(DATETIME, '" & Format(dtpDate.Value, "dd MMMM yyyy") & "', 102)) AND " & _
                                        "(dbo.tblIncomeBill.IsOPDBill = 1) AND (dbo.tblIncomeBill.Cancelled = 1) AND (dbo.tblIncomeBill.PaymentMethodID <> 4) AND (dbo.tblPatientService.ServiceSubCategoryID = " & temSCID & ") "
                ...
                '    SecTotal = 0
                    ...
                    With rsTem
                        ...
                        temSql = "SELECT     SUM(dbo.tblPatientService.HospitalCharge) AS SumOfHospitalCharge, SUM(dbo.tblPatientService.ProfessionalCharge) AS SumOfProfessionalCharge, SUM(dbo.tblPatientService.Charge) AS SumOfCharge  " & _
                                    "FROM         dbo.tblIncomeBill RIGHT OUTER JOIN dbo.tblPatientService ON dbo.tblIncomeBill.IncomeBillID = dbo.tblPatientService.OPDBillID " & _
                                    "WHERE   (dbo.tblPatientService.Deleted = 0) AND (dbo.tblIncomeBill.Completed = 1) AND (((dbo.tblIncomeBill.Cancelled = 0) AND (dbo.tblIncomeBill.CompletedDate = CONVERT(DATETIME, '" & Format(dtpDate.Value, "dd MMMM yyyy") & "', 102)) )   or ( (dbo.tblIncomeBill.Cancelled = 1) AND (dbo.tblIncomeBill.CancelledDate = CONVERT(DATETIME, '" & Format(dtpDate.Value, "dd MMMM yyyy") & "', 102))  )) AND " & _
                                    "(dbo.tblIncomeBill.IsOPDBill = 1) AND (dbo.tblIncomeBill.PaymentMethodID <> 4) AND (dbo.tblPatientService.ServiceCategoryID = " & temCatID & ") "
        ...
        While rsCat.EOF = False
            ...
            With rsTem
                ...
                temSql = "SELECT     SUM(dbo.tblPatientService.HospitalCharge) AS SumOfHospitalCharge, SUM(dbo.tblPatientService.ProfessionalCharge) AS SumOfProfessionalCharge, SUM(dbo.tblPatientService.Charge) AS SumOfCharge " & _
                            "FROM         dbo.tblIncomeBill RIGHT OUTER JOIN dbo.tblPatientService ON dbo.tblIncomeBill.IncomeBillID = dbo.tblPatientService.LabBillID " & _
                            "WHERE (dbo.tblPatientService.Deleted = 0) AND  (dbo.tblIncomeBill.Completed = 1) AND (dbo.tblIncomeBill.CancelledDate = CONVERT(DATETIME, '" & Format(dtpDate.Value, "dd MMMM yyyy") & "', 102)) AND " & _
                            "(dbo.tblIncomeBill.IsLabBill = 1)  AND (dbo.tblIncomeBill.Cancelled = 1) AND (dbo.tblIncomeBill.PaymentMethodID <> 4) AND (dbo.tblPatientService.ServiceCategoryID = " & temCatID & ") "
                    ...
                    While rsSC.EOF = False
                        ...
                        With rsTem
                            ...
                            temSql = "SELECT     SUM(dbo.tblPatientService.HospitalCharge) AS SumOfHospitalCharge, SUM(dbo.tblPatientService.ProfessionalCharge) AS SumOfProfessionalCharge, SUM(dbo.tblPatientService.Charge) AS SumOfCharge  " & _
                                        "FROM         dbo.tblIncomeBill RIGHT OUTER JOIN dbo.tblPatientService ON dbo.tblIncomeBill.IncomeBillID = dbo.tblPatientService.LabBillID " & _
                                        "WHERE    (dbo.tblPatientService.Deleted = 0) AND    (dbo.tblIncomeBill.Completed = 1) AND (dbo.tblIncomeBill.CompletedDate = CONVERT(DATETIME, '" & Format(dtpDate.Value, "dd MMMM yyyy") & "', 102)) AND " & _
                                        "(dbo.tblIncomeBill.IsLabBill = 1) AND (dbo.tblIncomeBill.PaymentMethodID <> 4) AND (dbo.tblPatientService.ServiceSubCategoryID = " & temSCID & ") "
                        ...
                        With rsTem
                            ...
                            temSql = "SELECT     SUM(dbo.tblPatientService.HospitalCharge) AS SumOfHospitalCharge, SUM(dbo.tblPatientService.ProfessionalCharge) AS SumOfProfessionalCharge, SUM(dbo.tblPatientService.Charge) AS SumOfCharge  " & _
                                        "FROM         dbo.tblIncomeBill RIGHT OUTER JOIN dbo.tblPatientService ON dbo.tblIncomeBill.IncomeBillID = dbo.tblPatientService.LabBillID " & _
                                        "WHERE    (dbo.tblPatientService.Deleted = 0) AND    (dbo.tblIncomeBill.Completed = 1) AND (dbo.tblIncomeBill.CancelledDate = CONVERT(DATETIME, '" & Format(dtpDate.Value, "dd MMMM yyyy") & "', 102)) AND " & _
                                        "(dbo.tblIncomeBill.IsLabBill = 1) AND (dbo.tblIncomeBill.Cancelled = 1) AND (dbo.tblIncomeBill.PaymentMethodID <> 4) AND (dbo.tblPatientService.ServiceSubCategoryID = " & temSCID & ") "
...
Private Sub BHTCollectionPayments()
    ...
    With rsTem
        If .State = 1 Then .Close
        temSql = "SELECT     dbo.tblIncomeBill.NetTotal, dbo.tblBHT.BHT, dbo.tblPatientMainDetails.FirstName " & _
                    "FROM dbo.tblIncomeBill LEFT OUTER JOIN dbo.tblBHT ON dbo.tblIncomeBill.BHTID = dbo.tblBHT.BHTID LEFT OUTER JOIN dbo.tblPatientMainDetails ON dbo.tblBHT.PatientID = dbo.tblPatientMainDetails.PatientID " & _
                    "WHERE (((tblIncomeBill.CompletedDate)='" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND ((tblIncomeBill.IsInwardPaymentBill)=1) AND ((tblIncomeBill.Completed)=1) AND ((tblIncomeBill.PaymentMethodID)<>4))"
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
        ...
        temSql = "SELECT     dbo.tblIncomeBill.NetTotal, dbo.tblBHT.BHT, dbo.tblPatientMainDetails.FirstName " & _
                    "FROM dbo.tblIncomeBill LEFT OUTER JOIN dbo.tblBHT ON dbo.tblIncomeBill.BHTID = dbo.tblBHT.BHTID LEFT OUTER JOIN dbo.tblPatientMainDetails ON dbo.tblBHT.PatientID = dbo.tblPatientMainDetails.PatientID " & _
                    "WHERE (((tblIncomeBill.CancelledDate)='" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND ((tblIncomeBill.IsInwardPaymentBill)=1) AND ((tblIncomeBill.Completed)=1) AND ((tblIncomeBill.Cancelled)=1) AND ((tblIncomeBill.PaymentMethodID)<>4))"
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                temDbl = temDbl - !NetTotal
                ...
                gridSummery.Col = 1
                gridSummery.CellAlignment = 1
                gridSummery.Text = "Cancellation - " & Format(!BHT, "") & " - " & Format(!FirstName, "")
                gridSummery.Col = 5
                gridSummery.Text = Format(!NetTotal, "###0.00")
                .MoveNext
            Wend
...
Private Sub GSBCollectionPayments()
    ...
    With rsTem
        If .State = 1 Then .Close
        temSql = "SELECT   dbo.tblIncomeBill.DisplayBillID,  dbo.tblIncomeBill.NetTotal, dbo.tblBHT.BHT, dbo.tblPatientMainDetails.FirstName FROM         dbo.tblIncomeBill LEFT OUTER JOIN                       dbo.tblBHT ON dbo.tblIncomeBill.BHTID = dbo.tblBHT.BHTID LEFT OUTER JOIN                       dbo.tblPatientMainDetails ON dbo.tblBHT.PatientID = dbo.tblPatientMainDetails.PatientID WHERE (((tblIncomeBill.CompletedDate)='" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND ((tblIncomeBill.IsGSBill)=1) AND ((tblIncomeBill.Completed)=1) AND ((tblIncomeBill.PaymentMethodID)<>4))"
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                temDbl = temDbl + !NetTotal
                ...
                gridSummery.Col = 1
                gridSummery.CellAlignment = 1
                gridSummery.Text = !DisplayBillID & " - " & Format(!BHT, "") & " - " & Format(!FirstName, "")
        ...
        .Close
        If .State = 1 Then .Close
        temSql = "SELECT    dbo.tblIncomeBill.DisplayBillID, dbo.tblIncomeBill.NetTotal, dbo.tblBHT.BHT, dbo.tblPatientMainDetails.FirstName FROM         dbo.tblIncomeBill LEFT OUTER JOIN                       dbo.tblBHT ON dbo.tblIncomeBill.BHTID = dbo.tblBHT.BHTID LEFT OUTER JOIN                       dbo.tblPatientMainDetails ON dbo.tblBHT.PatientID = dbo.tblPatientMainDetails.PatientID WHERE (((tblIncomeBill.CancelledDate)='" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND ((tblIncomeBill.IsGSBill)=1) AND ((tblIncomeBill.Completed)=1) AND ((tblIncomeBill.Cancelled)=1) AND ((tblIncomeBill.PaymentMethodID)<>4))"
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                temDbl = temDbl - !NetTotal
                ...
                gridSummery.Col = 1
                gridSummery.CellAlignment = 1
                gridSummery.Text = "Cancellation - " & !DisplayBillID & " - " & Format(!BHT, "") & " - " & Format(!FirstName, "")
                gridSummery.Col = 5
                gridSummery.Text = Format(!NetTotal, "###0.00")
                .MoveNext
            Wend
...
Private Sub PharmacyCollectionIncome()
    ...
    With rsTem
        If .State = 1 Then .Close
        temSql = "SELECT Sum(tblIncomeBill.NetTotal) AS SumOfNetTotal From tblIncomeBill WHERE (((tblIncomeBill.CompletedDate)='" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND ((tblIncomeBill.IsPharmacyBill)=1)AND ((tblIncomeBill.Completed)=1) AND ((tblIncomeBill.PaymentMethodID)<>4))"
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
    ...
    With rsTem
        If .State = 1 Then .Close
        temSql = "SELECT Sum(tblIncomeBill.NetTotal) AS SumOfNetTotal From tblIncomeBill WHERE (((tblIncomeBill.CancelledDate)='" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND ((tblIncomeBill.IsPharmacyBill)=1)AND ((tblIncomeBill.Completed)=1) AND ((tblIncomeBill.Cancelled)=1) AND ((tblIncomeBill.PaymentMethodID)<>4))"
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            If IsNull(!SumofNetTotal) = False Then
                temDbl = temDbl - !SumofNetTotal
            End If
        End If
        .Close
    End With
...
Private Sub AgentCollectionIncome()
    ...
    With rsTem
        If .State = 1 Then .Close
        temSql = "SELECT dbo.tblIncomeBill.NetTotal, dbo.tblIncomeBill.DisplayBillID, dbo.tblIncomeBill.IncomeBillID, dbo.tblAgent.Agent, dbo.tblAgent.Code FROM dbo.tblIncomeBill LEFT OUTER JOIN dbo.tblAgent ON dbo.tblIncomeBill.AgentID = dbo.tblAgent.AgentID WHERE (((tblIncomeBill.CompletedDate)='" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND ((tblIncomeBill.IsAgentBill)=1)AND ((tblIncomeBill.Completed)=1) AND ((tblIncomeBill.PaymentMethodID)<>4))"
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                temDbl = temDbl + !NetTotal
    ...
    With rsTem
        If .State = 1 Then .Close
        temSql = "SELECT dbo.tblIncomeBill.NetTotal, dbo.tblIncomeBill.DisplayBillID, dbo.tblIncomeBill.IncomeBillID, dbo.tblAgent.Agent, dbo.tblAgent.Code FROM dbo.tblIncomeBill LEFT OUTER JOIN dbo.tblAgent ON dbo.tblIncomeBill.AgentID = dbo.tblAgent.AgentID WHERE (((tblIncomeBill.CancelledDate)='" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND ((tblIncomeBill.IsAgentBill)=1)AND ((tblIncomeBill.Completed)=1) AND ((tblIncomeBill.Cancelled)=1) AND ((tblIncomeBill.PaymentMethodID)<>4))"
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                temDbl = temDbl - !NetTotal
                ...
                gridSummery.Col = 1
                gridSummery.CellAlignment = 1
                gridSummery.Text = "Cancellation - " & !DisplayBillID & " " & Format(!Agent, "") & " (" & Format(!Code, "") & ")"
                gridSummery.Col = 5
                gridSummery.Text = "(" & Format(!NetTotal, "###0.00") & ")"
                .MoveNext
            Wend
...
Private Sub HSSCollectionPayments()
    ...
    With rsTem
        If .State = 1 Then .Close
        temSql = "SELECT dbo.tblIncomeBill.NetTotal, dbo.tblIncomeBill.BHTID, dbo.tblHealthSchemeSuppliers.HealthSchemeSupplierName FROM dbo.tblIncomeBill LEFT OUTER JOIN dbo.tblHealthSchemeSuppliers ON dbo.tblIncomeBill.PaidHSSID = dbo.tblHealthSchemeSuppliers.HealthSchemeSupplierID WHERE (((tblIncomeBill.CompletedDate)='" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND ((tblIncomeBill.IsHSSPaymentBill)=1)AND ((tblIncomeBill.Completed)=1) AND ((tblIncomeBill.PaymentMethodID)<>4))"
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                gridSummery.Rows = gridSummery.Rows + 1
    ...
    With rsTem
        If .State = 1 Then .Close
        temSql = "SELECT dbo.tblIncomeBill.NetTotal, dbo.tblIncomeBill.BHTID, dbo.tblHealthSchemeSuppliers.HealthSchemeSupplierName FROM dbo.tblIncomeBill LEFT OUTER JOIN dbo.tblHealthSchemeSuppliers ON dbo.tblIncomeBill.PaidHSSID = dbo.tblHealthSchemeSuppliers.HealthSchemeSupplierID WHERE (((tblIncomeBill.CancelledDate)='" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND ((tblIncomeBill.IsHSSPaymentBill)=1)AND ((tblIncomeBill.Completed)=1) AND ((tblIncomeBill.Cancelled)=1) AND ((tblIncomeBill.PaymentMethodID)<>4))"
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                gridSummery.Rows = gridSummery.Rows + 1
                ...
                If !BHTID <> 0 Then
                    ...
                    gridSummery.Col = 1
                    gridSummery.CellAlignment = 1
                    gridSummery.Text = "Cancellation " & Format(!HealthSchemeSupplierName, "") & " (BHT " & temMyBHT.BHT & ")"
                Else
                    gridSummery.Col = 1
                    gridSummery.CellAlignment = 1
                    gridSummery.Text = "Cancellation " & Format(!HealthSchemeSupplierName, "")
                End If
    ...
    With rsTem
        ...
        If .RecordCount > 0 Then
            While .EOF = False
                ...
                gridSummery.Col = 1
                gridSummery.CellAlignment = 1
                gridSummery.Text = "Return " & Format(!HealthSchemeSupplierName, "")
                gridSummery.Col = 5
                gridSummery.Text = "(" & Format(!ReturnValue, "###0.00") & ")"
                .MoveNext
            Wend
...
Private Sub BHTProfessionalPayments()
    ...
    With rsTem
        ...
        temSql = "SELECT dbo.tblStaff.Name, dbo.tblProfessionalPaymentBill.Value " & _
                    ...
                    "WHERE (dbo.tblProfessionalPaymentBill.Date = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND (dbo.tblProfessionalPaymentBill.IsInwardPaymentBill = 1) "
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                temDbl = temDbl + !Value
...
'                gridSummery.Text = Format(!Value, "###0.00")
    ...
    With rsTem
        ...
        temSql = "SELECT dbo.tblStaff.Name, dbo.tblProfessionalPaymentBill.Value " & _
                    "FROM dbo.tblProfessionalPaymentBill LEFT OUTER JOIN dbo.tblStaff ON dbo.tblProfessionalPaymentBill.StaffID = dbo.tblStaff.StaffID " & _
                    "WHERE (dbo.tblProfessionalPaymentBill.CancelledDate = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND (dbo.tblProfessionalPaymentBill.Cancelled = 1) AND (dbo.tblProfessionalPaymentBill.IsInwardPaymentBill = 1) "
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                temDbl = temDbl - !Value
...
Private Sub OPDProfessionnalPayments()
    ...
    With rsTem
        ...
        temSql = "SELECT dbo.tblStaff.Name, dbo.tblProfessionalPaymentBill.Value " & _
                    "FROM dbo.tblProfessionalPaymentBill LEFT OUTER JOIN dbo.tblStaff ON dbo.tblProfessionalPaymentBill.StaffID = dbo.tblStaff.StaffID " & _
                    "WHERE (dbo.tblProfessionalPaymentBill.Date = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND (dbo.tblProfessionalPaymentBill.IsOPDBill = 1) "
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                temDbl = temDbl + !Value
...
'                gridSummery.Text = Format(!Value, "###0.00")
    ...
    With rsTem
        ...
        temSql = "SELECT dbo.tblStaff.Name, dbo.tblProfessionalPaymentBill.Value " & _
                    "FROM dbo.tblProfessionalPaymentBill LEFT OUTER JOIN dbo.tblStaff ON dbo.tblProfessionalPaymentBill.StaffID = dbo.tblStaff.StaffID " & _
                    "WHERE (dbo.tblProfessionalPaymentBill.CancelledDate = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND (dbo.tblProfessionalPaymentBill.Cancelled = 1) AND (dbo.tblProfessionalPaymentBill.IsOPDBill = 1) "
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                temDbl = temDbl - !Value
...
Private Sub GSBProfessionnalPayments()
    ...
    With rsTem
        ...
        temSql = "SELECT dbo.tblStaff.Name, dbo.tblProfessionalPaymentBill.Value " & _
                    "FROM dbo.tblProfessionalPaymentBill LEFT OUTER JOIN dbo.tblStaff ON dbo.tblProfessionalPaymentBill.StaffID = dbo.tblStaff.StaffID " & _
                    "WHERE (dbo.tblProfessionalPaymentBill.Date = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND (dbo.tblProfessionalPaymentBill.IsGSBill = 1) "
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                temDbl = temDbl + !Value
...
'                gridSummery.Text = Format(!Value, "###0.00")
    ...
    With rsTem
        ...
        temSql = "SELECT dbo.tblStaff.Name, dbo.tblProfessionalPaymentBill.Value " & _
                    "FROM dbo.tblProfessionalPaymentBill LEFT OUTER JOIN dbo.tblStaff ON dbo.tblProfessionalPaymentBill.StaffID = dbo.tblStaff.StaffID " & _
                    "WHERE (dbo.tblProfessionalPaymentBill.CancelledDate = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND (dbo.tblProfessionalPaymentBill.Cancelled = 1) AND (dbo.tblProfessionalPaymentBill.IsGSBill = 1) "
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                temDbl = temDbl + !Value
...
Private Sub LabProfessionnalPayments()
    ...
    With rsTem
        ...
        temSql = "SELECT dbo.tblStaff.Name, dbo.tblProfessionalPaymentBill.Value " & _
                    "FROM dbo.tblProfessionalPaymentBill LEFT OUTER JOIN dbo.tblStaff ON dbo.tblProfessionalPaymentBill.StaffID = dbo.tblStaff.StaffID " & _
                    "WHERE (dbo.tblProfessionalPaymentBill.Date = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND (dbo.tblProfessionalPaymentBill.IsLabBill = 1) "
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                temDbl = temDbl + !Value
...
'                gridSummery.Text = Format(!Value, "###0.00")
    ...
    With rsTem
        ...
        temSql = "SELECT dbo.tblStaff.Name, dbo.tblProfessionalPaymentBill.Value " & _
                    "FROM dbo.tblProfessionalPaymentBill LEFT OUTER JOIN dbo.tblStaff ON dbo.tblProfessionalPaymentBill.StaffID = dbo.tblStaff.StaffID " & _
                    "WHERE (dbo.tblProfessionalPaymentBill.CancelledDate = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND (dbo.tblProfessionalPaymentBill.Cancelled = 1) AND (dbo.tblProfessionalPaymentBill.IsLabBill = 1) "
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                temDbl = temDbl - !Value
...
Private Sub RProfessionnalPayments()
    ...
    With rsTem
        ...
        temSql = "SELECT dbo.tblStaff.Name, dbo.tblProfessionalPaymentBill.Value " & _
                    "FROM dbo.tblProfessionalPaymentBill LEFT OUTER JOIN dbo.tblStaff ON dbo.tblProfessionalPaymentBill.StaffID = dbo.tblStaff.StaffID " & _
                    "WHERE (dbo.tblProfessionalPaymentBill.Date = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND (dbo.tblProfessionalPaymentBill.IsRBill = 1) "
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                temDbl = temDbl + !Value
...
'                gridSummery.Text = Format(!Value, "###0.00")
    ...
    With rsTem
        ...
        temSql = "SELECT dbo.tblStaff.Name, dbo.tblProfessionalPaymentBill.Value " & _
                    "FROM dbo.tblProfessionalPaymentBill LEFT OUTER JOIN dbo.tblStaff ON dbo.tblProfessionalPaymentBill.StaffID = dbo.tblStaff.StaffID " & _
                    "WHERE (dbo.tblProfessionalPaymentBill.CancelledDate = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "') AND (dbo.tblProfessionalPaymentBill.Cancelled = 1) AND (dbo.tblProfessionalPaymentBill.IsRBill = 1) "
        .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            While .EOF = False
                temDbl = temDbl - !Value
