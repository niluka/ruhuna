...
Begin VB.Form frmRServiceCategoryList 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "View Roentgens Services"
   ClientHeight    =   8970
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   14055
   ...
   End
End
Attribute VB_Name = "frmRServiceCategoryList"
...
Private Sub btnExcel_Click()
    GridToExcel gridService, "Roentengens Service Bills " & cmbCat.Text, "From " & Format(dtpFrom.Value, "dd MMMM yyyy") & " to " & Format(dtpTo.Value, "dd MMMM yyyy")
End Sub

Private Sub btnPrint_Click()
    Dim ThisPrintReportSettings As PrintReport
    GetPrintDefaults ThisPrintReportSettings
    ThisPrintReportSettings.ColSpace = 100
    
    'ThisPrintReportSettings.ReportPrintOrientation = Landscape
    GridPrint gridService, ThisPrintReportSettings, "Roentgens Services", "From " & Format(dtpFrom.Value, "dd MMMM yyyy") & " to " & Format(dtpTo.Value, "dd MMMM yyyy")
    Printer.EndDoc
