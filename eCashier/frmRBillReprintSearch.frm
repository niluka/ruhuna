...
Begin VB.Form frmRBillReprintSearch 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Roentgents Bill Reprint"
   ClientHeight    =   8625
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   10995
   ...
   End
End
Attribute VB_Name = "frmRBillReprintSearch"
...
Private Sub FillGrid()
    ...
    With rsTem
        ...
        temSql = "SELECT tblIncomeBill.IncomeBillID as IBIncomeBillID,  tblIncomeBill.DisplayBillID, tblIncomeBill.CompletedTime as IBCompletedTime, tblPatientMainDetails.FirstName, tblPaymentMethod.PaymentMethod as MyPM, tblIncomeBill.NetTotal, tblBookedUser.Name as BName, tblCancelledUser.Name as CName, tblIncomeBill.Cancelled as IBCancelled, tblIncomeBill.CancelledDate as IBCancelledDate, tblIncomeBill.CancelledTime as IBCancelledTime, tblRefundMethod.PaymentMethod as MyRPM " & _
                    ...
                    "WHERE tblIncomeBill.Completed = 1  AND tblIncomeBill.IsRBill = 1  AND tblIncomeBill.CompletedDate = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "' "
        ...
        While .EOF = False
            ...
            gridBill.Col = 2
            gridBill.Text = Format(!IBCompletedTime, "hh:mm AMPM")
...
Private Sub btnToExcel_Click()
    GridToExcel gridBill, "Roentgents Bills", Format(dtpDate.Value, "dd MMMM yyyy") & " - " & cmbUser.Text & " - " & cmbPaymentMethod.Text
End Sub
...
Private Sub gridBill_DblClick()
    ...
    If temBillID <> 0 Then
        frmRBillReprint.txtBillID.Text = temBillID
        frmRBillReprint.Show
        frmRBillReprint.ZOrder 0
        frmRBillReprint.Top = 0
        frmRBillReprint.Left = 0
    End If
End Sub
