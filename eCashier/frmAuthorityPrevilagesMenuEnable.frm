...
Begin VB.Form frmAuthorityPrevilagesMenuEnable 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Authority Previlages - Enable or Diable Menus"
   ClientHeight    =   7695
   ClientLeft      =   2490
   ClientTop       =   -2445
   ClientWidth     =   13815
   ...
   Begin TabDlg.SSTab sstMenus 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Tab 0"
      TabPicture(0)   =   "frmAuthorityPrevilagesMenuEnable.frx":0000
   ...
   End
End
Attribute VB_Name = "frmAuthorityPrevilagesMenuEnable"
    ...
    With rsFormegory
        ...
        If .RecordCount > 0 Then
            ...
            While .EOF = False
                ...
                temSql = "Select * from tblControl where MainMenuID = " & !ControlID & " AND ControlType =  " & ControlType.MenuItem & " AND MainMenu = False "
