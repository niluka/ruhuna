...
Begin VB.Form frmAgentBillReprint 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Agent Payment Reprint"
   ClientHeight    =   8625
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   10995
   ...
   End
End
Attribute VB_Name = "frmAgentBillReprint"
...
Private Sub printBill()
    ...
    If SelectForm(cmbPaper.Text, Me.hwnd) = 1 Then
        temBillPoints = PrintThisBill("", cmbPaymentMethod.Text, "", Format(Date, "dd MM yyyy"), Format(Time, "hh:mm AMPM"), "Agent Payments", "")
