...
Begin VB.Form frmShiftEndSummery1 
   ...
   End
End
Attribute VB_Name = "frmShiftEndSummery1"
...
Private Sub FillDetails()
    ...
    lblCashTotalN.Caption = Format(CashTotal - (CashTotalC + CashTotalR), "#,##0.00")
    lblCreditTotalN.Caption = Format(CreditTotal - (CreditTotalC + CreditTotalR), "#,##0.00")
    lblChequeTotalN.Caption = Format(ChequeTotal - (ChequeTotalC + ChequeTotalR), "#,##0.00")
    lblSlipsTotalN.Caption = Format(SlipsTotal - (SlipsTotalC + SlipsTotalR), "#,##0.00")
    lblCardTotalN.Caption = Format(CardTotal - (CardTotalC + CardTotalR), "#,##0.00")
    ...
    lblGrandTotalN.Caption = Format(GrandTotal - (GrandTotalR + GrandTotalC), "#,##0.00")
