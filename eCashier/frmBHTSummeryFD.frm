...
Begin VB.Form frmBHTSummeryFD 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "BHT Summery FD"
   ClientHeight    =   10440
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   13440
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmBHTSummeryFD.frx":0000
      ...
      TabPicture(1)   =   "frmBHTSummeryFD.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "txtDiscountF"
      Tab(1).Control(1)=   "SSTab3"
      Tab(1).Control(2)=   "lblHospitalBillF"
      Tab(1).Control(3)=   "lblNetChargeF"
      Tab(1).Control(4)=   "lblTotalChargeF"
      Tab(1).Control(5)=   "lblPaymentsF"
      Tab(1).Control(6)=   "lblBalanceF"
      Tab(1).Control(7)=   "lblRoomChargeF"
      Tab(1).Control(8)=   "lblMedicineChargeF"
      Tab(1).Control(9)=   "lblServiceChargeF"
      Tab(1).Control(10)=   "lblLinenChargeF"
      Tab(1).Control(11)=   "lblAdmissionFeeF"
      Tab(1).Control(12)=   "lblMaintainChargesF"
      Tab(1).Control(13)=   "lblNursingChargesF"
      Tab(1).Control(14)=   "lblProfessionalChargesF"
      Tab(1).Control(15)=   "lblAdditionalChargeF"
      Tab(1).Control(16)=   "lblHCf"
      Tab(1).Control(17)=   "Label4"
      Tab(1).Control(18)=   "Label3"
      Tab(1).Control(19)=   "Label23"
      Tab(1).Control(20)=   "Label28"
      Tab(1).Control(21)=   "Label27"
      Tab(1).Control(22)=   "Label26"
      Tab(1).Control(23)=   "Label25"
      Tab(1).Control(24)=   "Label24"
      Tab(1).Control(25)=   "Label20"
      Tab(1).Control(26)=   "Label19"
      Tab(1).Control(27)=   "Label18"
      Tab(1).Control(28)=   "Label17"
      Tab(1).Control(29)=   "Label22"
      Tab(1).Control(30)=   "lblBalF"
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         TabHeight       =   520
         TabCaption(0)   =   "Rooms"
         TabPicture(0)   =   "frmBHTSummeryFD.frx":00C4
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "gridRoom"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Medicines"
         TabPicture(1)   =   "frmBHTSummeryFD.frx":00E0
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "gridMedicines"
         Tab(1).ControlCount=   1
         TabCaption(2)   =   "Services"
         TabPicture(2)   =   "frmBHTSummeryFD.frx":00FC
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "gridService"
         Tab(2).ControlCount=   1
         TabCaption(3)   =   "Professional"
         TabPicture(3)   =   "frmBHTSummeryFD.frx":0118
         Tab(3).ControlEnabled=   0   'False
         Tab(3).Control(0)=   "gridProfessional"
         Tab(3).ControlCount=   1
         TabCaption(4)   =   "Payments"
         TabPicture(4)   =   "frmBHTSummeryFD.frx":0134
         Tab(4).ControlEnabled=   0   'False
   ...
   End
End
Attribute VB_Name = "frmBHTSummeryFD"
...
Private Sub btnDischarge_Click()
    ...
    With rsTem
        ...
        If .RecordCount > 0 Then
            ...
            If !PaymentMethodID = 1 Then !MaintainaceCashDiscountRate = InwardPtCh.MaintainaceCashDiscountRate
...
Private Sub FakeCalculations()
    ...
    Else
        ...
        FPtMedicineCharge = FFillMedicines + AdditionalCharge
        FPtServiceCharge = FFillServices
        FPtLinanCharge = MyBHT.LinanCharge ' FLinanCharges
        
        If MyBHT.PaymentMethod = "Credit" Then
            FPtProfCharge = FFillProfessionalCharges
        End If
        
        FPtNursingCharge = MyBHT.NursingCharge '  FNursingCharge
        FPtMaintananceCharge = MyBHT.MaintananceCharge ' FMaintananceCharges
        FPtAdditionalCharge = FAdditionalCharge
...
'    If MyBHT.Discharge = True Then
'        FPtRoomCharge = MyBHT.RoomCharge
'        FPtAdmissionFee = MyBHT.AdmissionCharge
'        FPtLinanCharge = MyBHT.LinanCharge
'        FPtNursingCharge = MyBHT.NursingCharge
'    End If
...
Public Sub btnProcess_Click()
    ...
    InwardPtCh.BHTID = Val(cmbBHT.BoundText)
