...
Begin VB.Form frmAgeAnalysis 
   ...
   End
End
Attribute VB_Name = "frmAgeAnalysis"
    ...
    While rsHS.EOF = False
        With rsTem
            temSql = "SELECT  tblHealthSchemeSuppliers.HealthSchemeSupplierID,  tblHealthSchemeSuppliers.HealthSchemeSupplierName, tblBHT.* " & _
                        ...
                        "Where (((tblBHT.Discharge) = 1) AND ((tblBHT.BillSettled) = 0 )  AND ((tblBHT.HealthSchemeSupplierID) =  " & rsHS!HealthSchemeSupplierID & ") ) " & _
