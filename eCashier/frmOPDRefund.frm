...
Begin VB.Form frmOPDRefund 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmOPDRefund.frx":0000
      ...
      TabPicture(1)   =   "frmOPDRefund.frx":001C
...
Private Sub printBill()
    ...
    If SelectForm(cmbPaper.Text, Me.hwnd) = 1 Then
        temBillPoints = PrintThisBill(txtBillID.Text, cmbPaymentMethod.Text, txtDetail.Text, Format(Date, "dd MM yyyy"), Format(Time, "hh:mm AMPM"), "OPD Refund", "")
...
Private Sub btnSearch_Click()
    ...
    With rsTem
        If .State = 1 Then .Close
        temSql = "SELECT tblIncomeBill.*, tblBHTPatientMainDetails.FirstName as BHTFirstName, tblBHT.BHT, tblIncomeBill.CompletedDate as IBCompletedDate,  tblIncomeBill.CompletedTime as IBCompletedTime, tblPatientMainDetails.FirstName as OPDFirstName, tblPaymentMethod.PaymentMethod as MyPM, tblIncomeBill.NetTotal, tblBookedUser.Name as BName, tblCancelledUser.Name as CName, tblIncomeBill.Cancelled as IBCancelled, tblIncomeBill.CancelledDate as IBCancelledDate, tblIncomeBill.CancelledTime as IBCancelledTime, tblRefundMethod.PaymentMethod as MyRPM, tblIncomeBill.ReturnedValue as IBReturnValue " & _
                    ...
                    "WHERE IsOPDBill = 1 AND tblIncomeBill.DisplayBillID = " & Val(txtBillID.Text)
