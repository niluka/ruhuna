...
Begin VB.Form frmRServiceValues 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Roentgents Service Values"
   ClientHeight    =   9345
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   14055
   ...
   End
End
Attribute VB_Name = "frmRServiceValues"
...
Private Sub btnExcel_Click()
    GridToExcel gridService, "Service Values", ""
End Sub

Private Sub btnPrint_Click()
    Dim ThisReportFormat As PrintReport
    GetPrintDefaults ThisReportFormat
    GridPrint gridService, ThisReportFormat, "Roentgents Services", "From " & Format(dtpFrom.Value, "dd MMMM yyyy") & " to " & Format(dtpTo.Value, "dd MMMM yyyy")
        Printer.EndDoc
...
Private Sub FillGrid()
    ...
    With rsTem
        ...
        temSql = temSql & " AND tblPatientService.Deleted = 0 AND tblPatientService.RBillID <> 0 "
        ...
        End If
        temSql = temSql & " AND tblPatientService.RBILLID <> 0 AND tblPatientService.Deleted = 0 "
