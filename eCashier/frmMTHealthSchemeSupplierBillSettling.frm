...
Begin VB.Form frmMTHealthSchemeSupplierBillSettling 
   ...
   End
End
Attribute VB_Name = "frmMTHealthSchemeSupplierBillSettling"
...
'        .ColWidth(10) = 1600
        ...
        With rsBill
            ...
            temSQL = temSQL & "FROM         dbo.tblIncomeBill LEFT OUTER JOIN dbo.tblPatientMainDetails ON dbo.tblIncomeBill.PatientID = dbo.tblPatientMainDetails.PatientID LEFT OUTER JOIN dbo.tblHealthSchemeSuppliers ON dbo.tblIncomeBill.HSSID = dbo.tblHealthSchemeSuppliers.HealthSchemeSupplierID "
...
Private Sub printBill(CompanyName As String, PatientName As String, BHT As String, PaymentValue As Double, BillNo As Long)
    ...
    If SelectForm(cmbPaper.Text, Me.hwnd) = 1 Then
        ...
        MyFOnt.Bold = False
        MyFOnt.Size = 11
        PrintingText 0, temY, Printer.Width, 0, "Credit Settlement of Medical Tests", CentreAlign, MyFOnt
