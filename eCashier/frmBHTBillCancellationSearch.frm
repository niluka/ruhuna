...
Begin VB.Form frmBHTBillCancellationSearch 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "BHT Bill Cancellation"
   ClientHeight    =   8625
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   10995
   ...
   End
End
Attribute VB_Name = "frmBHTBillCancellationSearch"
...
Private Sub FillGrid()
    ...
    With rsTem
        ...
        temSql = "SELECT tblIncomeBill.IncomeBillID,  tblIncomeBill.DisplayBillID, tblIncomeBill.CompletedTime, tblPatientMainDetails.FirstName, tblPaymentMethod.PaymentMethod as MyPM, tblIncomeBill.NetTotal, tblBookedUser.Name as BName, tblCancelledUser.Name as CName, tblIncomeBill.Cancelled, tblIncomeBill.CancelledDate, tblIncomeBill.CancelledTime, tblRefundMethod.PaymentMethod as MyRPM, tblBHT.BHT " & _
                    ...
                    "WHERE tblIncomeBill.Completed = 1  AND tblBHT.IsBHT = 1  AND tblIncomeBill.IsInwardPaymentBill = 1  AND tblIncomeBill.CompletedDate = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "' "
...
Private Sub btnToCancel_Click()
    ...
    If temBillID <> 0 Then
        frmBHTBillCancellation.txtBillID.Text = temBillID
        frmBHTBillCancellation.Show
    Else
...
Private Sub btnToExcel_Click()
    GridToExcel gridBill, "BHT Bills", Format(dtpDate.Value, "dd MMMM yyyy") & vbTab & cmbUser.Text & vbTab & cmbPaymentMethod.Text
...
Private Sub gridBill_DblClick()
    ...
    If temBillID <> 0 Then
        frmBHTBillCancellation.txtBillID.Text = temBillID
        frmBHTBillCancellation.Show
        frmBHTBillCancellation.Top = 0
        frmBHTBillCancellation.Left = 0
    End If
End Sub
