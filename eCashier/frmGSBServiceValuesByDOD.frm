...
Begin VB.Form frmGSBServiceValuesByDOD 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "GSB Services by Date of Discharge"
   ClientHeight    =   9570
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   14055
   ...
   End
End
Attribute VB_Name = "frmGSBServiceValuesByDOD"
...
Private Sub FillGrid()
    ...
    With rsTem
        ...
        temSql = "SELECT Sum(tblPatientService.HospitalCharge) AS SumOfHCharge, Sum(tblPatientService.ProfessionalCharge) AS SumOfPCharge, Count(tblPatientService.Charge) AS CountOfCharge, tblServiceCategory.ServiceCategory, tblServiceSubcategory.ServiceSubcategory, tblServiceCategory.InwardSurcharge " & _
                    ...
                    "WHERE tblBHT.IsGSB = 1 AND tblBHT.DOD Between '" & Format(dtpFrom.Value, "dd MMMM yyyy") & "' And '" & Format(dtpTo.Value, "dd MMMM yyyy") & "' AND tblPatientService.Deleted = 0 AND tblPatientService.BHTID <> 0  AND tblBHT.Discharge = 1 "
