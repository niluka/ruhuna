...
Begin VB.Form frmOPDBillCancellationSearch 
   ...
   End
End
Attribute VB_Name = "frmOPDBillCancellationSearch"
...
Public Sub FillGrid()
    ...
    With rsTem
        ...
        temSql = "SELECT tblIncomeBill.*, tblIncomeBill.IncomeBillID as IBIncomeBillID, tblIncomeBill.DisplayBillID, tblIncomeBill.CompletedTime as IBCompletedTime, tblPatientMainDetails.FirstName, tblPaymentMethod.PaymentMethod as MyPM, tblIncomeBill.NetTotal, tblBookedUser.Name as BName,  tblIncomeBill.Cancelled as IBCancelled, tblIncomeBill.CancelledDate as IBCancelledDate, tblIncomeBill.CancelledTime as IBCancelledTime, tblCancelledUser.Name as CName, tblRefundMethod.PaymentMethod as MyRPM " & _
