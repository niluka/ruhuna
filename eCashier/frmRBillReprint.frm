...
Begin VB.Form frmRBillReprint 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Reprint of Roentgents Bills"
   ClientHeight    =   7575
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9825
   ...
   End
End
Attribute VB_Name = "frmRBillReprint"
...
Private Sub printBill()
    ...
    If SelectForm(cmbPaper.Text, Me.hwnd) = 1 Then
        temBillPoints = PrintThisBill(txtDisplayBillID.Text, txtPM.Text, txtPt.Text, Format(Date, "dd MM yyyy"), Format(Time, "hh:mm AMPM"), "Roentgents Bill Reprint", "")
