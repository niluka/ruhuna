...
Begin VB.Form frmOPDServiceCategoryList 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "View OPD Services"
   ClientHeight    =   8970
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   14055
   ...
   End
End
Attribute VB_Name = "frmOPDServiceCategoryList"
...
Private Sub btnExcel_Click()
    GridToExcel gridService, "OPD Service Bills " & cmbCat.Text, "From " & Format(dtpFrom.Value, "dd MMMM yyyy") & " to " & Format(dtpTo.Value, "dd MMMM yyyy")
End Sub
...
Private Sub btnPrint_Click()
    ...
    GridPrint gridService, ThisPrintReportSettings, "OPD Services", "From " & Format(dtpFrom.Value, "dd MMMM yyyy") & " to " & Format(dtpTo.Value, "dd MMMM yyyy")
    Printer.EndDoc
