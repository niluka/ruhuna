...
Begin VB.Form frmLabBillReprint 
   ...
   End
End
Attribute VB_Name = "frmLabBillReprint"
...
Private Sub printBill()
    ...
    If SelectForm(cmbPaper.Text, Me.hwnd) = 1 Then
        temBillPoints = PrintThisBill(txtDisplayBillID.Text, txtPM.Text, txtPt.Text, Format(Date, "dd MM yyyy"), Format(Time, "hh:mm AMPM"), "Laboratory Bill Reprint", "")
