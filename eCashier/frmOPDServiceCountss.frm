...
Begin VB.Form frmOPDServiceCounts 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "OPD Service Counts"
   ClientHeight    =   8970
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   14055
   ...
   End
End
Attribute VB_Name = "frmOPDServiceCounts"
...
Private Sub btnPrint_Click()
    ...
    GridPrint gridService, ThisReportFormat, "Servies", "From " & Format(dtpFrom.Value, "dd MMMM yyyy") & " to " & Format(dtpTo.Value, "dd MMMM yyyy")
        Printer.EndDoc
...
Private Sub FillGrid()
    ...
    With rsTem
        ...
        temSql = "SELECT Count(tblServiceCategory.ServiceCategory) AS CountOfServiceCategory, Count(tblServiceSubcategory.ServiceSubcategory) AS CountOfServiceSubcategory, tblServiceCategory.ServiceCategory, tblServiceSubcategory.ServiceSubcategory " & _
        ...
        temSql = temSql & " AND tblPatientService.Deleted = 0 "
        ...
        While .EOF = False
            ...
            gridService.Col = 1
            gridService.Text = Format(!CountOfServiceCategory, "0")
            
            gridService.Col = 2
            gridService.Text = Format(!ServiceSubcategory, "")
            
            gridService.Col = 3
            gridService.Text = Format(!CountOfServiceSubcategory, "0")
