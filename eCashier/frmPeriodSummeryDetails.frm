...
Begin VB.Form frmPeriodSummeryDetails 
   ...
   End
End
Attribute VB_Name = "frmPeriodSummeryDetails"
...
Private Sub CatPay(ByVal IncomeCategory As String, PaymentMethodID As Long)
    With rsTem
        If .State = 1 Then .Close
        temSql = "SELECT ProfessionalPaymentBillID, StaffID, Date, Value, Time, PaymentComments  " & _
