...
Begin VB.Form frmLabServiceValues 
   ...
   End
End
Attribute VB_Name = "frmLabServiceValues"
...
Private Sub btnExcel_Click()
    GridToExcel gridService, "Lab Services"
End Sub

Private Sub btnPrint_Click()
    Dim ThisReportFormat As PrintReport
    GetPrintDefaults ThisReportFormat
    GridPrint gridService, ThisReportFormat, "Lab Services", "From " & Format(dtpFrom.Value, "dd MMMM yyyy") & " to " & Format(dtpTo.Value, "dd MMMM yyyy")
        Printer.EndDoc
...
Private Sub FillGrid()
    ...
    With rsTem
        ...
        temSql = temSql & " AND tblPatientService.Deleted = 0 AND tblPatientService.LabBillID <> 0 "
        ...
        End If
        temSql = temSql & " AND tblPatientService.LabBILLID <> 0 AND tblPatientService.Deleted = 0 "
