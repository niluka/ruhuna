...
Begin VB.Form frmBHTBillReprintSearch 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "BHT Bill Reprint"
   ClientHeight    =   8625
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   10995
   ...
   End
End
Attribute VB_Name = "frmBHTBillReprintSearch"
...
Private Sub gridBill_DblClick()
    ...
    If temBillID <> 0 Then
        ...
        frmBHTBillReprint.txtBillID.Text = temBillID
        frmBHTBillReprint.Show
        frmBHTBillReprint.Top = 0
        frmBHTBillReprint.Left = 0
    End If
End Sub
