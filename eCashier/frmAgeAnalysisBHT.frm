...
Begin VB.Form frmAgeAnalysisBHT 
   ...
   End
End
Attribute VB_Name = "frmAgeAnalysisBHT"
...
Private Sub btnToExcel_Click()
    GridToExcel gridBalance, "BHT Age Analysis", Format(Date, "dd MMMM yyyy") & vbTab & Time
...
Private Sub FillList()
    ...
    While rsHS.EOF = False
        With rsTem
            temSql = "SELECT  tblHealthSchemeSuppliers.HealthSchemeSupplierID,  tblHealthSchemeSuppliers.HealthSchemeSupplierName, tblBHT.* " & _
                        "FROM tblHealthSchemeSuppliers LEFT JOIN tblBHT ON tblHealthSchemeSuppliers.HealthSchemeSupplierID = tblBHT.HealthSchemeSupplierID " & _
                        "Where (((tblBHT.Discharge) = 1) AND ((tblBHT.DOD) Between '" & Format(dtpFrom.Value, "dd MMMM yyyy") & "' AND '" & Format(dtpTo.Value, "dd MMMM yyyy") & "' )  AND ((tblBHT.BillSettled) = 0 )  AND ((tblBHT.HealthSchemeSupplierID) =  " & rsHS!HealthSchemeSupplierID & ") ) " & _
...
'                    Case Is < 30:
'                                    Below30dBalance = Below30dBalance + !NetPrice
'                                    Below30dBalanceTotal = Below30dBalanceTotal + !NetPrice
'                    Case 30 To 60:
'                                    Between30And60Balance = Between30And60Balance + !NetPrice
'                                    Between30And60BalanceTotal = Between30And60BalanceTotal + !NetPrice
'                    Case 61 To 90:
'                                    Between60And90Balance = Between60And90Balance + !NetPrice
'                                    Between60And90BalanceTotal = Between60And90BalanceTotal + !NetPrice
'                    Case Is > 90:
'                                    Above90Balance = Above90Balance + !NetPrice
'                                    Above90BalanceTotal = Above90BalanceTotal + !NetPrice
'                    Case Else
'                        MsgBox "Error"
'
'                End Select
