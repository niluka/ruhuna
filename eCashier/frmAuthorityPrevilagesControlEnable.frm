...
Begin VB.Form frmAuthorityPrevilagesControlEnable 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Authority Previlages - Enable Controls"
   ClientHeight    =   7695
   ClientLeft      =   660
   ClientTop       =   -2445
   ClientWidth     =   13815
   ...
   Begin TabDlg.SSTab sstMenus 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Tab 0"
      TabPicture(0)   =   "frmAuthorityPrevilagesControlEnable.frx":0000
   ...
   End
End
Attribute VB_Name = "frmAuthorityPrevilagesControlEnable"
