...
Begin VB.Form frmExpenceBillCancellation 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cancellation of Expence Bills"
   ClientHeight    =   8175
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9825
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmExpenceBillCancellation.frx":0000
      ...
      TabPicture(1)   =   "frmExpenceBillCancellation.frx":001C
   ...
   End
End
Attribute VB_Name = "frmExpenceBillCancellation"
...
Private Sub btnCancelBill_Click()
    ...
    With rsTem
        If .State = 1 Then .Close
        temSql = "Select * from tblProfessionalCharges where ForExpenceBIllID = " & Val(txtBillID.Text)
        .Open temSql, cnnStores, adOpenStatic, adLockOptimistic
        If .RecordCount > 0 Then
            While .EOF = False
                !Cancelled = True
...
Private Sub printBill()
    ...
    If SelectForm(cmbPaper.Text, Me.hwnd) = 1 Then
        ...
        MyFOnt.Bold = False
        MyFOnt.Size = 11
        PrintingText 0, temY, Printer.Width, 0, "Expence Bill Cancellation", CentreAlign, MyFOnt
        ...
        temY = Printer.CurrentY
        PrintingText FieldX, temY, ValueX, 0, "Cancelled Bill No : " & txtDisplayBillID.Text, leftAlign, MyFOnt
...
Private Sub FillGrid()
    ...
    With rsTem
        ...
        temSql = "SELECT tblPatientService.PatientServiceID, tblPatientService.ServiceDate, tblServiceCategory.ServiceCategory, tblServiceSubcategory.ServiceSubcategory, tblPatientService.Comments, tblPatientService.HospitalCharge " & _
                    ...
                    "WHERE (((tblPatientService.Deleted)=0) AND ((tblPatientService.ExpenceBillID)<> 0)  AND ((tblPatientService.ExpenceBillID)=" & Val(txtBillID.Text) & ")) " & _
        ...
        While .EOF = False
            ...
            temSql = "SELECT tblStaff.Name, tblProfessionalCharges.* " & _
                        ...
                        "WHERE (((tblProfessionalCharges.ForExpenceBillID)=" & Val(txtBillID.Text) & "))"
