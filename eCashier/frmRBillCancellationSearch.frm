...
Begin VB.Form frmRBillCancellationSearch 
   ...
   End
End
Attribute VB_Name = "frmRBillCancellationSearch"
...
Private Sub btnToExcel_Click()
    GridToExcel gridBill, "Roentgents Bills", Format(dtpDate.Value, "dd MMMM yyyy") & vbTab & cmbUser.Text & vbTab & cmbPaymentMethod.Text
...
Private Sub gridBill_DblClick()
    ...
    If temBillID <> 0 Then
        frmRBillCancellation.txtBillID.Text = temBillID
        frmRBillCancellation.Show
        frmRBillCancellation.ZOrder 0
        frmRBillCancellation.Top = 0
        frmRBillCancellation.Left = 0
    End If
End Sub
