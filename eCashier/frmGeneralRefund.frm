...
Begin VB.Form frmOPDRefund 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmGeneralRefund.frx":0000
      ...
      TabPicture(1)   =   "frmGeneralRefund.frx":001C
...
Private Sub printBill()
    ...
    If SelectForm(cmbPaper.Text, Me.hwnd) = 1 Then
        ...
        MyFOnt.Bold = False
        MyFOnt.Size = 12
        PrintingText 0, 0, Printer.Width, 0, "Refund", CentreAlign, MyFOnt
...
Private Sub btnSearch_Click()
    ...
    With rstem
        If .State = 1 Then .Close
        temSql = "SELECT tblIncomeBill.*, tblBHTPatientMainDetails.FirstName, tblBHT.BHT, tblIncomeBill.Time, tblPatientMainDetails.FirstName, tblPaymentMethod.PaymentMethod, tblIncomeBill.NetTotal, tblBookedUser.Name, tblCancelledUser.Name, tblIncomeBill.Cancelled, tblIncomeBill.CancelledDate, tblIncomeBill.CancelledTime, tblCancelledUser.Name, tblRefundMethod.PaymentMethod, tblIncomeBill.ReturnedValue " & _
        ...
        If .RecordCount > 0 Then
            ...
            temText = temText & vbNewLine & "Bill Time : " & Format(![tblIncomeBill.Time], "HH : MM (AMPM)") & " "
