...
Begin VB.Form frmExpenceBillCancellationSearch 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Expence Bill Cancellation"
   ClientHeight    =   8625
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   10995
   ...
   End
End
Attribute VB_Name = "frmExpenceBillCancellationSearch"
...
Private Sub FillGrid()
    ...
    With rsTem
        ...
        temSql = "SELECT tblIncomeBill.*, tblIncomeBill.IncomeBillID as IBIncomeBillID, tblIncomeBill.DisplayBillID, tblIncomeBill.CompletedTime as IBBillCompletedTime ,  tblIncomeBill.CompletedDate as IBCompletedDate , tblPatientMainDetails.FirstName, tblPaymentMethod.PaymentMethod as MyPM, tblIncomeBill.NetTotal, tblBookedUser.Name as BName, tblCancelledUser.Name as CName, tblIncomeBill.Cancelled as IBCancelled, tblIncomeBill.CancelledDate as IBCancelledDate, tblIncomeBill.CancelledTime as IBCancelledTime, tblRefundMethod.PaymentMethod as MyRPM " & _
                    ...
                    "WHERE tblIncomeBill.Completed = 1  AND tblIncomeBill.IsExpenceBill = 1  AND tblIncomeBill.CompletedDate = '" & Format(dtpDate.Value, "dd MMMM yyyy") & "' "
...
Private Sub btnToExcel_Click()
    GridToExcel gridBill, "Expences", Format(dtpDate.Value, "dd MMMM yyyy") & vbTab & cmbUser.Text & vbTab & cmbPaymentMethod.Text
...
Private Sub gridBill_DblClick()
    ...
    If temBillID <> 0 Then
        frmExpenceBillCancellation.txtBillID.Text = temBillID
        frmExpenceBillCancellation.Show
        frmExpenceBillCancellation.ZOrder 0
        frmExpenceBillCancellation.Top = 0
        frmExpenceBillCancellation.Left = 0
    End If
End Sub
