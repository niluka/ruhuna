...
Begin VB.Form frmLabProfessionalPayments 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Professional Fee Payments for Labbilles"
   ClientHeight    =   8250
   ClientLeft      =   855
   ClientTop       =   -2445
   ClientWidth     =   10965
   ...
   Begin VB.TextBox txtCount 
      ...
      Width           =   1815
   End
   Begin btButtonEx.ButtonEx btnSelectAll 
      Height          =   375
      Left            =   1200
      TabIndex        =   33
      Top             =   5400
   ...
   End
End
Attribute VB_Name = "frmLabProfessionalPayments"
...
Private Sub FillList()
    ...
    With rsTem
        ...
        temSql = temSql & "FROM (((tblPatientService RIGHT JOIN tblProfessionalCharges ON tblPatientService.PatientServiceID = tblProfessionalCharges.PatientServiceID) LEFT JOIN tblServiceCategory ON tblPatientService.ServiceCategoryID = tblServiceCategory.ServiceCategoryID) LEFT JOIN tblServiceSubcategory ON tblPatientService.ServiceSubcategoryID = tblServiceSubcategory.ServiceSubcategoryID) LEFT JOIN tblIncomeBill ON tblProfessionalCharges.ForLabBillID = tblIncomeBill.IncomeBillID "
        ...
        temSql = temSql & " AND ForLabBillID <> 0 "
        ...
        While .EOF = False
            ...
            temText = temText & Right(Space(8) & Format(![DisplayBillID], "0"), 8) & vbTab
            temText = temText & Left(![ServiceSubcategory] & Space(7), 7) & vbTab
