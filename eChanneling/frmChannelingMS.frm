...
Begin VB.Form frmChannelingMS 
   ...
   Begin VB.ListBox ListDatesAndSecessions 
      ...
      EndProperty
      Height          =   4350
      ItemData        =   "frmChannelingMS.frx":0442
      Left            =   5760
      List            =   "frmChannelingMS.frx":0444
      TabIndex        =   2
   ...
   Begin VB.ListBox ListPatientFacilities 
      ...
      EndProperty
      Height          =   4350
      ItemData        =   "frmChannelingMS.frx":0446
      Left            =   9600
      List            =   "frmChannelingMS.frx":0448
      TabIndex        =   3
   ...
   Begin VB.ListBox ListConsultants 
      ...
      EndProperty
      Height          =   4350
      ItemData        =   "frmChannelingMS.frx":044A
      Left            =   3000
      List            =   "frmChannelingMS.frx":044C
      TabIndex        =   1
   ...
   Begin VB.ListBox ListSpecialities 
      ...
      EndProperty
      Height          =   4350
      ItemData        =   "frmChannelingMS.frx":044E
      Left            =   240
      List            =   "frmChannelingMS.frx":0450
      TabIndex        =   0
   ...
   Begin TabDlg.SSTab SSTab2 
      ...
      TabPicture(0)   =   "frmChannelingMS.frx":0452
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "FramePatientDetails"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Reprint"
      TabPicture(1)   =   "frmChannelingMS.frx":046E
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "FrameReprints"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Cancel"
      TabPicture(2)   =   "frmChannelingMS.frx":048A
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "FrameCancellations"
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "Refund"
      TabPicture(3)   =   "frmChannelingMS.frx":04A6
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "FrameRefunds"
      Tab(3).ControlCount=   1
      TabCaption(4)   =   "Settle "
      TabPicture(4)   =   "frmChannelingMS.frx":04C2
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "bttnAgentBookingValidation"
      Tab(4).Control(1)=   "FrameSettleCredit"
      Tab(4).ControlCount=   2
      TabCaption(5)   =   "Change"
      TabPicture(5)   =   "frmChannelingMS.frx":04DE
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "Frame6"
      Tab(5).ControlCount=   1
      TabCaption(6)   =   "Search"
      TabPicture(6)   =   "frmChannelingMS.frx":04FA
      Tab(6).ControlEnabled=   0   'False
      Tab(6).Control(0)=   "Frame5"
      Tab(6).ControlCount=   1
      TabCaption(7)   =   "Views"
      TabPicture(7)   =   "frmChannelingMS.frx":0516
   ...
   Begin VB.Frame FramePatient 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabHeight       =   520
         TabCaption(0)   =   "&Cash"
         TabPicture(0)   =   "frmChannelingMS.frx":0532
         Tab(0).ControlEnabled=   0   'False
         Tab(0).Control(0)=   "FrameCash"
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "A&gent"
         TabPicture(1)   =   "frmChannelingMS.frx":054E
         Tab(1).ControlEnabled=   -1  'True
         Tab(1).Control(0)=   "FrameAgent"
         Tab(1).Control(0).Enabled=   0   'False
         Tab(1).ControlCount=   1
         TabCaption(2)   =   "Cr&edit"
         TabPicture(2)   =   "frmChannelingMS.frx":056A
         Tab(2).ControlEnabled=   0   'False
         ...
         Begin VB.Frame FrameAgent 
            ...
            Top             =   360
            Width           =   4455
            Begin VB.TextBox txtAgentContactNo 
               Height          =   360
               Left            =   1680
               MaxLength       =   25
               TabIndex        =   202
...
Private Sub GetPatientDetails()
    ...
    If !Cancelled = True Then
        ...
        txtOtherRepayC.Text = Empty
    ElseIf !Refund = True Then
        txtCancelRefund.Text = "Refunded on " & Format(!repaydate, DefaultLongDate) & "  at " & Format(!RepayTime, "hh:mm AMPM") & "  by " & FindStaffFromID(!repayUser_ID) & ". Rs. " & Format(!totalrefund, "0.00") & " was repaied."
        FrameCancellations.Enabled = False
        FrameRefunds.Enabled = False
        txtRepayTotalC.Text = Empty
        txtRepayTotalR.Text = Empty
...
Private Sub txtAgentContactNo_Change()
    txtContactNo.Text = txtAgentContactNo.Text
End Sub

Private Sub txtAgentContactNo_KeyPress(KeyAscii As Integer)
...
Private Sub txtAgentPatientName_KeyPress(KeyAscii As Integer)
    If KeyAscii = 13 Then txtAgentContactNo.SetFocus
End Sub
