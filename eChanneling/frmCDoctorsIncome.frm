...
Begin VB.Form frmCDoctorsIncome 
   ...
   EndProperty
   Icon            =   "frmCDoctorsIncome.frx":0000
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ScaleHeight     =   9015
   ...
   End
End
Attribute VB_Name = "frmCDoctorsIncome"
...
TemTotal = 0
    ...
    With DataEnvironment1
       ...
       Select Case SSTab1.Tab
        ...
        Case 0
        .Commands!cmmdDuctorsPayment_Grouping.CommandText = PreSHape & Sql & " Where (BookingDate = #" & Date & "#) and (FullyPaid = True) and (PaidToSTaff = False)" & PostSHape 'and (PaidToSTaff = False)
         .cmmdDuctorsPayment_Grouping
        Case 1
        .Commands!cmmdDuctorsPayment_Grouping.CommandText = PreSHape & Sql & " Where (BookingDate = # " & DTPicker1.Value & "#) and (FullyPaid = True) and (PaidToSTaff = False)" & PostSHape
         .cmmdDuctorsPayment_Grouping
        Case 2
        .Commands!cmmdDuctorsPayment_Grouping.CommandText = PreSHape & Sql & " Where (BookingDate Between  # " & DTPicker2.Value & "# and  # " & DTPicker3.Value & "# ) and (FullyPaid = True) and (PaidToSTaff = False) " & PostSHape
         .cmmdDuctorsPayment_Grouping
        End Select
        i = 1
        r = 1
       ...
       Select Case SSTab1.Tab
        ...
        Case 0
            If optTopay.Value = True Then
                .Commands!cmmdDuctorsPayment_Grouping.CommandText = PreSHape & Sql & " Where (BookingDate = #" & Date & "#) and (FullyPaid = True) and (PaidToSTaff = False)" & PostSHape
                .cmmdDuctorsPayment_Grouping
            End If
            If optPaid.Value = True Then
                .Commands!cmmdDuctorsPayment_Grouping.CommandText = PreSHape & Sql & " Where (BookingDate = #" & Date & "#) and (FullyPaid = True) and (PaidToSTaff = True)" & PostSHape
                .cmmdDuctorsPayment_Grouping
            End If
            If optAll.Value = True Then
                .Commands!cmmdDuctorsPayment_Grouping.CommandText = PreSHape & Sql & " Where (BookingDate = #" & Date & "#) and (FullyPaid = True)" & PostSHape
                .cmmdDuctorsPayment_Grouping
            End If
        ...
        Case 1
           ...
           End If
           If optPaid.Value = True Then
                .Commands!cmmdDuctorsPayment_Grouping.CommandText = PreSHape & Sql & " Where (BookingDate = # " & DTPicker1.Value & "#) and (FullyPaid = True) and (PaidToSTaff = True)" & PostSHape
                .cmmdDuctorsPayment_Grouping
           End If
           If optAll.Value = True Then
                .Commands!cmmdDuctorsPayment_Grouping.CommandText = PreSHape & Sql & " Where (BookingDate = # " & DTPicker1.Value & "#) and (FullyPaid = True) " & PostSHape
                .cmmdDuctorsPayment_Grouping
           End If
        ...
        Case 2
            ...
            End If
            If optPaid.Value = True Then
                .Commands!cmmdDuctorsPayment_Grouping.CommandText = PreSHape & Sql & " Where (BookingDate Between  # " & DTPicker2.Value & "# and  # " & DTPicker3.Value & "# ) and (FullyPaid = True) and (PaidToSTaff = True) " & PostSHape
                .cmmdDuctorsPayment_Grouping
            End If
            If optAll.Value = True Then
                .Commands!cmmdDuctorsPayment_Grouping.CommandText = PreSHape & Sql & " Where (BookingDate Between  # " & DTPicker2.Value & "# and  # " & DTPicker3.Value & "# ) and (FullyPaid = True)" & PostSHape
                .cmmdDuctorsPayment_Grouping
            End If
