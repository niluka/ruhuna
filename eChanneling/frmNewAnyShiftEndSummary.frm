...
Begin VB.Form frmNewAnyShiftEndSummary 
   ...
   EndProperty
   Icon            =   "frmNewAnyShiftEndSummary.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin MSDataListLib.DataCombo DataComboStaff 
      Bindings        =   "frmNewAnyShiftEndSummary.frx":038A
      Height          =   360
      Left            =   120
      TabIndex        =   111
      Top             =   3960
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmNewAnyShiftEndSummary.frx":03A9
      ...
      TabPicture(1)   =   "frmNewAnyShiftEndSummary.frx":03C5
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "bttnCashSUmmery"
      Tab(1).Control(1)=   "Frame2"
      Tab(1).Control(2)=   "Frame1"
      Tab(1).Control(3)=   "bttnPrintCashBookings"
      Tab(1).Control(4)=   "bttnPrintCreditSettling"
      Tab(1).Control(5)=   "bttnPrintCashRepayments"
      Tab(1).ControlCount=   6
      TabCaption(2)   =   "Agent Bookings"
      TabPicture(2)   =   "frmNewAnyShiftEndSummary.frx":03E1
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Frame7"
      Tab(2).Control(1)=   "Frame6"
      Tab(2).Control(2)=   "bttnPrintAgentRepayments"
      Tab(2).Control(3)=   "bttnPrintAgentPayments"
      Tab(2).Control(4)=   "ButtonEx1"
      Tab(2).Control(5)=   "ButtonEx2"
      Tab(2).ControlCount=   6
      TabCaption(3)   =   "Payments"
      TabPicture(3)   =   "frmNewAnyShiftEndSummary.frx":03FD
      Tab(3).ControlEnabled=   -1  'True
      Tab(3).Control(0)=   "Frame5"
      Tab(3).Control(0).Enabled=   0   'False
      Tab(3).Control(1)=   "bttnDoctorPaymentsDoneToday"
   ...
   End
End
Attribute VB_Name = "frmNewAnyShiftEndSummary"
...
Private Sub bttnCashSummery_Click()
 With dtrTemCashBookings
    ...
    End If
        .Sections("Section4").Controls.Item("lblTopic").Caption = "Cash Bookings By " & DataComboStaff.Text
        .Sections("Section4").Controls.Item("lblSubTopic").Caption = Format(Date, DefaultLongDate)
...
CSetPrinter.SetPrinterAsDefault (ReportPrinterName)
    ...
    With dtrTodayDocPayments
        ...
        If HospitalDetails = True Then
            ...
            .Sections("section4").Controls("lblReport").Caption = "Doctor Payments done Today By " & DataComboStaff.Text
...
With DataEnvironment1.rssqlTem3
    If .State = 1 Then .Close
     .Source = "Select tblAgentCashSettle.*, tblInstitutions.* fROM tblAgentCashSettle Left Join tblInstitutions On tblAgentCashSettle.Institution_Id = tblInstitutions.Institution_ID  Where (tblAgentCashSettle.SettledDate = '" & Date & "') and User_ID =" & DataComboStaff.BoundText
    .Open
    End With
    With dtrAgentCashReceive
        ...
        .Sections("Section2").Controls.Item("RptCashierName").Caption = DataComboStaff.Text
...
With dtrCashRefunds
    ...
    End If
    .Sections.Item("Section4").Controls.Item("lblreport").Caption = "All Agent Repayments by " & DataComboStaff.Text
...
With dtrCashBookings
    ...
    If HospitalDetails = True Then
        ...
        .Sections.Item("Section4").Controls.Item("lblInstitutionaddress").Caption = InstitutionAddress
    End If
    .Sections.Item("Section4").Controls.Item("lblreport").Caption = "All Cash Bookings By " & DataComboStaff.Text
    .Sections.Item("Section4").Controls.Item("lblreportsub").Caption = Format(Date, DefaultLongDate)
    .Sections.Item("Section3").Controls.Item("lblad").Caption = LongAd
    .Show
End With
...
With DataEnvironment1.rsRefunds
    If .State = 1 Then .Close
    .Source = "SELECT tblTitle.Title, tblDoctor.DoctorName, tblPatientFacility.*, tblPatientMainDetails.FirstName, tblPatientFacility.SettleCashDate, tblInstitutions.InstitutionName, tblInstitutions.InstitutionCode FROM tblInstitutions RIGHT JOIN (tblPatientMainDetails RIGHT JOIN (tblPatientFacility LEFT JOIN (tblDoctor LEFT JOIN tblTitle ON tblDoctor.DoctorTitle_ID = tblTitle.Title_ID) ON tblPatientFacility.Staff_ID = tblDoctor.Doctor_ID) ON tblPatientMainDetails.Patient_ID = tblPatientFacility.PatientID) ON tblInstitutions.Institution_ID = tblPatientFacility.Agent_ID Where (((tblPatientFacility.HospitalFacility_ID) = 10) And ((tblPatientFacility.RepayUser_ID) = " & DataComboStaff.BoundText & ") And ((tblPatientFacility.RefundToPatient) = 1) And ((tblPatientFacility.Repaydate) = '" & Date & "') ) ORDER BY tblPatientFacility.PatientFacility_ID"
    .Open
End With
With dtrCashRefunds
    .DataMember = "refunds"
    If HospitalDetails = True Then
        ...
        .Sections.Item("Section4").Controls.Item("lblInstitutionaddress").Caption = InstitutionAddress
    End If
    .Sections.Item("Section4").Controls.Item("lblreport").Caption = "All Cash Repayments By " & DataComboStaff.Text
    .Sections.Item("Section4").Controls.Item("lblreportsub").Caption = Format(Date, DefaultLongDate)
    .Sections.Item("Section3").Controls.Item("lblad").Caption = LongAd
    .Show
End With
...
With dtrCreditBookings
    ...
    If HospitalDetails = True Then
        ...
        .Sections.Item("Section4").Controls.Item("lblInstitutionaddress").Caption = InstitutionAddress
    End If
    .Sections.Item("Section4").Controls.Item("lblreport").Caption = "All Cash For Credit Bookings By " & DataComboStaff.Text
    .Sections.Item("Section4").Controls.Item("lblreportsub").Caption = Format(Date, DefaultLongDate)
    .Sections.Item("Section3").Controls.Item("lblad").Caption = LongAd
    .Show
End With
...
CSetPrinter.SetPrinterAsDefault (ReportPrinterName)
    ...
    With dtrSummeryReport
        ...
        End If
        .Sections("Section4").Controls.Item("lblreport").Caption = "Shift End Summery - " & DataComboStaff.Text
...
Private Sub DataComboStaff_Click(Area As Integer)
...
Private Sub CalculateIncome()
    If Not IsNumeric(DataComboStaff.BoundText) Then Exit Sub
...
' *******************************************************
    ...
    TemWhere = " WHERE (((tblPatientFacility.BookingDate)='" & Date & "') AND ((tblPatientFacility.User_ID)=" & DataComboStaff.BoundText & ") AND ((tblPatientFacility.HospitalFacility_ID)=10) AND ((tblPatientFacility.PaymentMode)='Cash')) "
...
' *******************************************************
    ...
    temSQL = "SELECT sum (TotalFee) as TotalGrand, sum(personalfee) as TotalDoctorFee , sum(institutionfee) as TotalHospitalFee  "
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = " WHERE (((tblPatientFacility.SettleCashDate)='" & Date & "') AND ((tblPatientFacility.CreditSettleUser_ID)=" & DataComboStaff.BoundText & ")  AND ((tblPatientFacility.HospitalFacility_ID)=10)  AND ((tblPatientFacility.PaymentMode)='Credit')) "
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
...
' *******************************************************
    ...
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = " WHERE (((tblPatientFacility.RepayDate)='" & Date & "') AND ((tblPatientFacility.RepayUser_ID)=" & DataComboStaff.BoundText & ")  AND ((tblPatientFacility.HospitalFacility_ID)=10)  AND ((tblPatientFacility.RefundToPatient)=1))  AND (((tblPatientFacility.Cancelled)=1) or ((tblPatientFacility.Refund)=1)) "
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
...
' *******************************************************
    ...
    temSQL = "SELECT sum (Totalrefund) as TotalGrand, sum(personalrefund) as TotalDoctorFee , sum(institutionrefund) as TotalHospitalFee  "
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = " WHERE (((tblPatientFacility.RepayDate)='" & Date & "') AND ((tblPatientFacility.RepayUser_ID)=" & DataComboStaff.BoundText & ") AND ((tblPatientFacility.HospitalFacility_ID)=10)  AND ((tblPatientFacility.RefundToAgent)=1))  AND (((tblPatientFacility.Cancelled)=1) or ((tblPatientFacility.Refund)=1))"
...
' *******************************************************
    ...
    temSQL = "SELECT sum (Totalrefund) as TotalGrand, sum(personalrefund) as TotalDoctorFee , sum(institutionrefund) as TotalHospitalFee  "
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = " WHERE (((tblPatientFacility.RepayDate)='" & Date & "') AND ((tblPatientFacility.RepayUser_ID)=" & DataComboStaff.BoundText & ") AND ((tblPatientFacility.HospitalFacility_ID)=10)  AND ((tblPatientFacility.RefundToAgent)=1))  AND (((tblPatientFacility.Cancelled)=1) or ((tblPatientFacility.Refund)=1)) and paymentmode = 'Agent'"
    With DataEnvironment1.rssqlTem1                                  ' RepayUser_ID
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
...
' *******************************************************
    ...
    temSQL = "SELECT sum (Totalrefund) as TotalGrand, sum(personalrefund) as TotalDoctorFee , sum(institutionrefund) as TotalHospitalFee  "
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = " WHERE (((tblPatientFacility.RepayDate)='" & Date & "') AND ((tblPatientFacility.RepayUser_ID)=" & DataComboStaff.BoundText & ") AND ((tblPatientFacility.HospitalFacility_ID)=10)  AND ((tblPatientFacility.RefundToPatient)=1))  AND (((tblPatientFacility.Cancelled)=1) or ((tblPatientFacility.Refund)=1)) and paymentmode = 'Agent' "
    With DataEnvironment1.rssqlTem1                                                       ' RepayUser_ID
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
...
' *******************************************************
    ...
    temSQL = "SELECT sum (Totalfee) as TotalGrand, sum(personalfee) as TotalDoctorFee , sum(institutionfee) as TotalHospitalFee  "
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = "WHERE (((tblPatientFacility.BookingDate)='" & Date & "') AND ((tblPatientFacility.HospitalFacility_ID)=10) AND ((tblPatientFacility.user_ID)=" & DataComboStaff.BoundText & ") AND ((tblPatientFacility.PaymentMode)='Agent'))"
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
...
' *******************************************************
    ...
    TemWhere = " where SettledDate = '" & Date & "' and User_ID =" & DataComboStaff.BoundText
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
...
'    TemWhere = " where PaidDate = '" & Date & "' and User_id =" & DataComboStaff.BoundText
'    With DataEnvironment1.rssqlTem1
'        If .State = 1 Then .Close
'        .Source = TemSql & TemWhere
'        .Open
...
' Doctor Cash By AppointmentDate
    ...
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = " WHERE (((tblPatientFacility.BookingDate)='" & Date & "') AND ((tblPatientFacility.HospitalFacility_ID)=10) AND ((tblPatientFacility.user_ID)=" & DataComboStaff.BoundText & ") AND ((tblPatientFacility.PaymentMode)='Cash')) and appointmentdate = '" & Date & "'"
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
    ...
    temSQL = "SELECT sum (personalFee) as TotalGrand "
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = " WHERE (((tblPatientFacility.SettleCashDate)='" & Date & "') AND ((tblPatientFacility.HospitalFacility_ID)=10) AND ((tblPatientFacility.CreditSettleUser_ID)=" & DataComboStaff.BoundText & ")  AND ((tblPatientFacility.PaymentMode)='Credit')) and appointmentdate = '" & Date & "'"
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
    ...
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = " WHERE (((tblPatientFacility.RepayDate)='" & Date & "') AND ((tblPatientFacility.HospitalFacility_ID)=10) AND ((tblPatientFacility.RepayUser_ID)=" & DataComboStaff.BoundText & ")  AND ((tblPatientFacility.RefundToPatient)=1))  AND (((tblPatientFacility.Cancelled)=1) or ((tblPatientFacility.Refund)=1)) and appointmentdate = '" & Date & "'"
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
    ...
    With DataEnvironment1.rssqlTem
        ...
        If .RecordCount > 0 Then
            ...
            While TemMinDate + TemNum <= TemMaxDate
                ...
                temSQL = "SELECT sum (personalFee) as TotalGrand "
                temSQL = temSQL & " FROM tblPatientFacility "
                TemWhere = " WHERE (((tblPatientFacility.BookingDate)='" & Date & "') AND ((tblPatientFacility.HospitalFacility_ID)=10) AND ((tblPatientFacility.user_ID)=" & DataComboStaff.BoundText & ") AND  ((tblPatientFacility.PaymentMode)='Cash')) and appointmentdate = '" & TemDate & "'"
                    If .State = 1 Then .Close
                    .Source = temSQL & TemWhere
                    .Open
                    If .RecordCount <> 0 Then
                ...
                temSQL = "SELECT sum (personalFee) as TotalGrand "
                temSQL = temSQL & " FROM tblPatientFacility "
                TemWhere = " WHERE (((tblPatientFacility.SettleCashDate)='" & Date & "') AND ((tblPatientFacility.CreditSettleUser_ID)=" & DataComboStaff.BoundText & ") AND  ((tblPatientFacility.HospitalFacility_ID)=10) AND ((tblPatientFacility.PaymentMode)='Credit')) and appointmentdate = '" & TemDate & "'"
                    If .State = 1 Then .Close
                    .Source = temSQL & TemWhere
                    .Open
                    If .RecordCount <> 0 Then
                ...
                temSQL = "SELECT sum(personalrefund) as TotalDoctorFee "
                temSQL = temSQL & " FROM tblPatientFacility "
                TemWhere = " WHERE (((tblPatientFacility.RepayDate)='" & Date & "') AND ((tblPatientFacility.HospitalFacility_ID)=10)  AND  ((tblPatientFacility.RepayUser_ID)=" & DataComboStaff.BoundText & ")  AND  ((tblPatientFacility.RefundToPatient)=1))  AND (((tblPatientFacility.Cancelled)=1) or ((tblPatientFacility.Refund)=1)) and appointmentdate = '" & TemDate & "'"
                With DataEnvironment1.rssqlTem1
                    If .State = 1 Then .Close
                    .Source = temSQL & TemWhere
                    .Open
...
' *******************************************************
    ...
    temSQL = "SELECT sum (Totalrefund) as TotalGrand, sum(personalrefund) as TotalDoctorFee , sum(institutionrefund) as TotalHospitalFee  "
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = " WHERE (((tblPatientFacility.RepayDate)='" & Date & "') AND ((tblPatientFacility.HospitalFacility_ID)=10)  AND ((tblPatientFacility.RepayUser_ID)=" & DataComboStaff.BoundText & ") AND ((tblPatientFacility.RefundToPatient)=1))  AND (((tblPatientFacility.Cancelled)=1) or ((tblPatientFacility.Refund)=1)) and paymentmode = 'Agent' "
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
...
' *******************************************************
    ...
    temSQL = "SELECT sum (Totalrefund) as TotalGrand, sum(personalrefund) as TotalDoctorFee , sum(institutionrefund) as TotalHospitalFee  "
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = " WHERE (((tblPatientFacility.RepayDate)='" & Date & "') AND ((tblPatientFacility.HospitalFacility_ID)=10) AND ((tblPatientFacility.RepayUser_ID)=" & DataComboStaff.BoundText & ")  AND ((tblPatientFacility.RefundToAgent)=1))   "
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
...
' ************* TotalRepayments ****************
    ...
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = " WHERE (((tblPatientFacility.RepayDate)='" & Date & "') AND ((tblPatientFacility.HospitalFacility_ID)=10) AND ((tblPatientFacility.RepayUser_ID)=" & DataComboStaff.BoundText & ")   AND ((tblPatientFacility.RefundToPatient)=1))  AND (((tblPatientFacility.Cancelled)=1) or ((tblPatientFacility.Refund)=1)) "
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
...
' *******************************************************
    ...
    temSQL = "SELECT sum(Totalrefund) as TotalGrand "
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = " WHERE (((tblPatientFacility.RepayDate)='" & Date & "') AND ((tblPatientFacility.HospitalFacility_ID)=10) AND ((tblPatientFacility.RepayUser_ID)=" & DataComboStaff.BoundText & ")   AND ((tblPatientFacility.RefundToAgent)=1))  AND (((tblPatientFacility.Cancelled)=1) or ((tblPatientFacility.Refund)=1))"
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
...
' *******************************************************
    ...
    temSQL = "SELECT sum(Totalrefund) as TotalGrand "
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = " WHERE tblPatientFacility.RepayDate='" & Date & "' AND  ((tblPatientFacility.RepayUser_ID)=" & DataComboStaff.BoundText & ") and  tblPatientFacility.HospitalFacility_ID=10  AND (tblPatientFacility.Cancelled=1 or tblPatientFacility.Refund=1)"
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
...
' Total Doctor Payments for cash bookings
    ...
    If PayToDoctor = False Then
        TemWhere = TemWhere & " and patientabsent = 0 and user_ID = " & DataComboStaff.BoundText & " "
    End If
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
...
' Total Doctor Payments for credit bookings
    ...
    If PayToDoctor = False Then
        TemWhere = TemWhere & " and patientabsent = 0 and CreditSettleUser_ID = " & DataComboStaff.BoundText & " "
    End If
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
...
' Doctor Agent By AppointmentDate
    ...
    temSQL = "SELECT sum (personalFee) as TotalGrand "
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = " WHERE (((tblPatientFacility.BookingDate)='" & Date & "') AND ((tblPatientFacility.HospitalFacility_ID)=10) AND ((tblPatientFacility.PaymentMode)='Agent')) and appointmentdate = '" & Date & "' and User_ID = " & DataComboStaff.BoundText
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
    ...
    temSQL = "SELECT sum(personalrefund) as TotalDoctorFee "
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = " WHERE  ((tblPatientFacility.PaymentMode)='Agent') and (((tblPatientFacility.RepayDate)='" & Date & "') AND ((tblPatientFacility.HospitalFacility_ID)=10)  AND ((tblPatientFacility.RefundToPatient)=1)  AND appointmentdate = '" & Date & "' ) and RepayUser_ID = " & DataComboStaff.BoundText
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
    ...
    temSQL = "SELECT sum(personalrefund) as TotalDoctorFee "
    temSQL = temSQL & " FROM tblPatientFacility "
    TemWhere = " WHERE  ((tblPatientFacility.PaymentMode)='Agent') and (((tblPatientFacility.RepayDate)='" & Date & "') AND ((tblPatientFacility.HospitalFacility_ID)=10)  AND ((tblPatientFacility.RefundToAgent)=1)  AND ((appointmentdate) = '" & Date & "')  AND ((RepayUser_ID) = " & DataComboStaff.BoundText & "))"
    With DataEnvironment1.rssqlTem1
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
    ...
    With DataEnvironment1.rssqlTem
        temSQL = "Select max(appointmentDate) as MaxBookingDate , min(appointmentdate) as MinBookingDate from tblpatientfacility "
        TemWhere = " where (paymentmode = 'Agent' and bookingdate ='" & Date & "') or ( repaydate = '" & Date & "'  ) "
        If .State = 1 Then .Close
        .Source = temSQL & TemWhere
        .Open
        If Not IsNull(!MaxBookingDate) Then
        ...
        If .RecordCount > 0 Then
            ...
            While TemMinDate + TemNum <= TemMaxDate
                ...
                temSQL = "SELECT sum (personalFee) as TotalGrand "
                temSQL = temSQL & " FROM tblPatientFacility "
                TemWhere = " WHERE (((tblPatientFacility.BookingDate)='" & Date & "') AND ((tblPatientFacility.HospitalFacility_ID)=10) AND ((tblPatientFacility.PaymentMode)='Agent')) and appointmentdate = '" & TemDate & "' and User_ID = " & DataComboStaff.BoundText
                    If .State = 1 Then .Close
                    .Source = temSQL & TemWhere
                    .Open
                    If .RecordCount <> 0 Then
                ...
                temSQL = "SELECT sum(personalrefund) as TotalDoctorFee "
                temSQL = temSQL & " FROM tblPatientFacility "
                TemWhere = " WHERE tblPatientFacility.RepayDate='" & Date & "' AND tblPatientFacility.HospitalFacility_ID = 10 AND tblPatientFacility.PaymentMode='Agent' AND tblPatientFacility.RefundToPatient= 1  and appointmentdate = '" & TemDate & "' and RepayUser_ID = " & DataComboStaff.BoundText
                With DataEnvironment1.rssqlTem1
                    If .State = 1 Then .Close
                    .Source = temSQL & TemWhere
                    .Open
                ...
                temSQL = "SELECT sum(personalrefund) as TotalDoctorFee "
                temSQL = temSQL & " FROM tblPatientFacility "
                TemWhere = " WHERE tblPatientFacility.RepayDate='" & Date & "' AND tblPatientFacility.HospitalFacility_ID=10 AND tblPatientFacility.PaymentMode='Agent' AND tblPatientFacility.RefundToAgent=1  and appointmentdate = '" & TemDate & "' and RepayUser_ID = " & DataComboStaff.BoundText
                With DataEnvironment1.rssqlTem1
                    If .State = 1 Then .Close
                    .Source = temSQL & TemWhere
                    .Open
...
With DataEnvironment1.rsCashBookings
    If .State = 1 Then .Close
    .Source = "SELECT tblTitle.Title, tblDoctor.DoctorName, tblPatientFacility.*, tblPatientMainDetails.FirstName FROM tblPatientMainDetails RIGHT JOIN (tblPatientFacility LEFT JOIN (tblDoctor LEFT JOIN tblTitle ON tblDoctor.DoctorTitle_ID = tblTitle.Title_ID) ON tblPatientFacility.Staff_ID = tblDoctor.Doctor_ID) ON tblPatientMainDetails.Patient_ID = tblPatientFacility.PatientID WHERE (((tblPatientFacility.HospitalFacility_ID)=10) AND ((tblPatientFacility.PaymentMode)='Agent') AND ((tblPatientFacility.bookingdate)='" & Date & "') ) ORDER BY tblPatientFacility.PatientFacility_ID "
    .Open
End With
With dtrAgentBookings
    ...
    If HospitalDetails = True Then
        ...
        .Sections.Item("Section4").Controls.Item("lblInstitutionaddress").Caption = InstitutionAddress
    End If
    .Sections.Item("Section4").Controls.Item("lblreport").Caption = "All Agent Bookings by " & DataComboStaff.Text
    .Sections.Item("Section4").Controls.Item("lblreportsub").Caption = Format(Date, DefaultLongDate)
    .Sections.Item("Section3").Controls.Item("lblad").Caption = LongAd
    .Show
End With
...
With dtrTemCashBookings
    If HospitalDetails = True Then
        ...
        .Sections("Section4").Controls.Item("lblAddress").Caption = InstitutionAddress
    End If
        .Sections("Section4").Controls.Item("lblTopic").Caption = "Agent Bookings By " & DataComboStaff.Text
        .Sections("Section4").Controls.Item("lblSubTopic").Caption = Format(Date, DefaultLongDate)
