...
Public Sub GetPrintDefaults(MyPrintDefaults As PrintReport)
    ...
    With MyPrintDefaults
        ...
        .BottomMargin = Printer.Height - (1440 / 2)
        .ColSpace = 350
        .ColFontName = "Verdana"
        .ColFontSize = 10
        .ColFontBold = False
        ...
        .PageNoX = Printer.Width - 1440 * 2
        .PageNoY = Printer.Height - (1440 * 1)
...
Public Sub ListPrint(Topic As String, SubTopic As String, list As ListBox, MyPrintReport As PrintReport)
    Printer.Font.Name = MyPrintReport.TopicFontName
    Printer.Font.Size = MyPrintReport.TopicFontSize
    Printer.Font.Bold = MyPrintReport.TopicFontBold
    Printer.Font.Italic = MyPrintReport.TopicFontItalic
    
    
    Printer.Print Topic
    
    Printer.Font.Name = MyPrintReport.SubTopicFontName
    Printer.Font.Size = MyPrintReport.SubTopicFontSize
    Printer.Font.Bold = MyPrintReport.SubTopicFontBold
    Printer.Font.Italic = MyPrintReport.SubTopicFontItalic
    
    
    Printer.Print SubTopic
    
    Printer.Print
    
    
    Printer.Font.Name = MyPrintReport.ColFontName
    Printer.Font.Size = MyPrintReport.ColFontSize
    Printer.Font.Bold = MyPrintReport.ColFontBold
    Printer.Font.Italic = MyPrintReport.ColFontItalic
