...
Begin VB.Form frmAppointmentsC 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmAppointmentsC.frx":0000
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "MonthView1"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Selected Period"
      TabPicture(1)   =   "frmAppointmentsC.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "MonthView2"
      Tab(1).Control(1)=   "MonthView3"
   ...
   End
End
Attribute VB_Name = "frmAppointmentsC"
