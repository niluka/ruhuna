...
Begin VB.Form frmNewShiftEndSummary 
   ...
   EndProperty
   Icon            =   "frmNewShiftEndSummary.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmNewShiftEndSummary.frx":038A
      ...
      Tab(0).Control(22)=   "lblStaffBookings"
      Tab(0).Control(22).Enabled=   0   'False
      Tab(0).Control(23)=   "Label1(10)"
      Tab(0).Control(23).Enabled=   0   'False
      Tab(0).Control(24)=   "lblTelephoneBookings"
      Tab(0).Control(24).Enabled=   0   'False
      Tab(0).Control(25)=   "Label1(1)"
      Tab(0).Control(25).Enabled=   0   'False
      Tab(0).Control(26)=   "bttnPrintSummery"
      Tab(0).Control(26).Enabled=   0   'False
      Tab(0).ControlCount=   27
      TabCaption(1)   =   "Cash Bookings"
      TabPicture(1)   =   "frmNewShiftEndSummary.frx":03A6
      ...
      Tab(1).Control(5)=   "bttnCashSUmmery"
      Tab(1).ControlCount=   6
      TabCaption(2)   =   "Agent Bookings"
      TabPicture(2)   =   "frmNewShiftEndSummary.frx":03C2
      ...
      TabPicture(3)   =   "frmNewShiftEndSummary.frx":03DE
      ...
      Begin VB.Label Label1 
         ...
         Width           =   3255
      End
      Begin VB.Label lblTelephoneBookings 
         Alignment       =   1  'Right Justify
         Caption         =   "0.00"
         Height          =   255
         Left            =   5400
      ...
      Begin VB.Label Label1 
         ...
         Width           =   3255
      End
      Begin VB.Label lblStaffBookings 
         Alignment       =   1  'Right Justify
         Caption         =   "0.00"
         Height          =   255
         Left            =   5400
   ...
   Begin MSDataListLib.DataCombo DataComboStaff 
      Bindings        =   "frmNewShiftEndSummary.frx":03FA
      Height          =   360
      Left            =   120
      TabIndex        =   111
      Top             =   120
   ...
   End
End
Attribute VB_Name = "frmNewShiftEndSummary"
