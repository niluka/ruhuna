...
Begin VB.Form frmChannelingRefund 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Channeling Refund"
   ClientHeight    =   8730
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   6960
   Icon            =   "frmChannelingRefund.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmChannelingRefund"
...
Private Sub Setcolours()
    ...
    frmChannelingRefund.BackColor = FrmBackColour
    frmChannelingRefund.ForeColor = FrmForeColour
...
With Printer
        ...
        TemTab5 = 36
        TemTab6 = 30
        Printer.Print Tab(TemTab4); "Channeling Refund"
        Printer.Print
        ...
        Printer.Print Tab(TemTab6); " : ";
        Printer.Print Tab(TemTab3 + 8 - Len(Format(Val(txtInstitutionRepay.Text) + Val(txtStaffRepay.Text), "0.00"))); Format(Val(txtInstitutionRepay.Text) + Val(txtStaffRepay.Text), "0.00")
        Printer.Print
