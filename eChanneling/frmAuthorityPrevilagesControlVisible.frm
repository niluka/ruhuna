...
Begin VB.Form frmAuthorityPrevilagesControlVisible 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Authority Previlages - Control Visible"
   ClientHeight    =   7695
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   13815
   ...
   Begin TabDlg.SSTab sstMenus 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Tab 0"
      TabPicture(0)   =   "frmAuthorityPrevilagesControlVisible.frx":0000
   ...
   End
End
Attribute VB_Name = "frmAuthorityPrevilagesControlVisible"
...
Private Sub FillControls()
    ...
    With rsFormegory
        If .State = 1 Then .Close
        temSql = "SELECT * from tblForm where Deleted = 0"
        .Open temSql, cnnChannelling, adOpenStatic, adLockReadOnly
