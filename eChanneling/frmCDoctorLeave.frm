...
Begin VB.Form frmCDoctorLeave 
   ...
   End
End
Attribute VB_Name = "frmCDoctorLeave"
...
Private Sub FillLeaveDays()
    ...
    With DataEnvironment1.rssqlTem
        If .State = 1 Then .Close
        .Source = "SELECT * from tblfacilitysecession where hospitalfacility_ID = 10 and staff_ID = " & ListConsultantIDs.Text & " and altereddate >= #" & Date & "# and fulldayleave = true order by altereddate"
