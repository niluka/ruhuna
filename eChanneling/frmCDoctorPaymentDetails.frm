...
Begin VB.Form frmCDoctorPaymentDetails 
   ...
   Begin VB.Frame FrameDoctorSelection 
      ...
      Begin VB.Frame FrameSelectDoctor 
         ...
         Begin VB.ListBox ListSpecialities 
            ...
            EndProperty
            Height          =   2400
            ItemData        =   "frmCDoctorPaymentDetails.frx":0000
            Left            =   120
            List            =   "frmCDoctorPaymentDetails.frx":0002
            TabIndex        =   7
         ...
         Begin VB.ListBox ListConsultants 
            ...
            EndProperty
            Height          =   2400
            ItemData        =   "frmCDoctorPaymentDetails.frx":0004
            Left            =   2880
            List            =   "frmCDoctorPaymentDetails.frx":0006
            TabIndex        =   6
   ...
   Begin MSHierarchicalFlexGridLib.MSHFlexGrid Grid1 
      Bindings        =   "frmCDoctorPaymentDetails.frx":0008
      Height          =   3735
      Left            =   120
      TabIndex        =   1
      Top             =   3840
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmCDoctorPaymentDetails.frx":0027
      ...
      TabPicture(1)   =   "frmCDoctorPaymentDetails.frx":0043
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "OptionLastYear"
      Tab(1).Control(1)=   "MonthViewTo"
      Tab(1).Control(2)=   "OptionThisweek"
      Tab(1).Control(3)=   "OptionLastWeek"
      Tab(1).Control(4)=   "OptionThisMonth"
      Tab(1).Control(5)=   "OptionLastMonth"
      Tab(1).Control(6)=   "OptionThisYear"
      Tab(1).Control(7)=   "MonthViewFrom"
   ...
   End
End
Attribute VB_Name = "frmCDoctorPaymentDetails"
...
Private Sub FillGrid()
    ...
    With DataEnvironment1
        ...
        If OptionAllDoctors.Value = True Then
            .Commands!cmmdDoctorPayments_Grouping.CommandText = PreSHape & Sql & "  (appointmentdate Between  #" & TemStartDate & "# and #" & TemEndDate & "#)  and  tblpatientfacility.paidtostaff = true and " & PostSHape
        Else
            .Commands!cmmdDoctorPayments_Grouping.CommandText = PreSHape & Sql & "  (appointmentdate Between  #" & TemStartDate & "# and #" & TemEndDate & "#)  and  tblpatientfacility.staff_ID = " & ListConsultantIDs.Text & " And tblpatientfacility.paidtostaff = true and " & PostSHape
        End If
