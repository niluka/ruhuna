...
Begin VB.Form frmAllBookings 
   ...
   End
End
Attribute VB_Name = "frmAllBookings"
...
Private Sub btnExcel_Click()
    GridToExcel grid, "All Bookings", Format(dtpDate.Value, "dd MMMM yyyy")
End Sub
...
"WHERE     (dbo.tblPatientFacility.BookingDate = CONVERT(DATETIME, '" & Format(dtpDate.Value, "dd MMMM yyyy") & "', 102))  " & _
