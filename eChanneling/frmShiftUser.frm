...
Begin VB.Form frmShiftUser 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Lakmedipro - eHospital Assistant - Shift User"
   ClientHeight    =   2715
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   6360
   ...
   End
End
Attribute VB_Name = "frmShiftUser"
...
Private Sub cmdCancel_Click()
    ...
    TemResponce = MsgBox("You log off was not successful", vbCritical, "Not logged off")
    Unload Me
End Sub
...
'        Next
        ...
        Unload Me
        MDIFrmReception.Caption = "Lakmedipro eHospital - Reception" & " - " & UserName
End Sub
...
TemResponce = MsgBox("Are you sure you want to log off and there is another user waiting to log in?", vbQuestion + vbYesNo, "Log off?")
