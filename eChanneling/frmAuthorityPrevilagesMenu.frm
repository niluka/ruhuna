...
Begin VB.Form frmAuthorityPrevilagesMenu 
   ...
   Begin TabDlg.SSTab sstMenus 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Tab 0"
      TabPicture(0)   =   "frmAuthorityPrevilagesMenu.frx":0000
   ...
   End
End
Attribute VB_Name = "frmAuthorityPrevilagesMenu"
...
Private Sub FillControls()
    ...
    With rsFormegory
        If .State = 1 Then .Close
        temSql = "SELECT * from tblControl where Deleted = False AND MainMenu = True"
        .Open temSql, cnnChannelling, adOpenStatic, adLockReadOnly
