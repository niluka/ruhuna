...
Begin VB.Form frmPurchaseCancellationSelection 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Purchase Bill Cancellation Selection"
   ClientHeight    =   1065
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   6390
   ...
   End
End
Attribute VB_Name = "frmPurchaseCancellationSelection"
    ...
    With rsRefillBill
        ...
        If .RecordCount > 0 Then
            ...
            ElseIf !Returned = True Then
                MsgBox "YOU HAVE ALREADY RETURNED THIS GRN" & vbNewLine & !DistributorName
                txtRefillBillID.SetFocus
                SendKeys "{HOME}+{END}"
                Exit Sub
            Else
