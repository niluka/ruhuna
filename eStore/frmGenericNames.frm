...
Begin VB.Form frmGenericNames 
   ...
   End
End
Attribute VB_Name = "frmGenericNames"
...
Option Explicit
    ...
    Dim rsGenericName As New ADODB.Recordset
    Dim FRows As Long
    Dim NowROw As Long
...
Private Sub FillGenaricCombo()
    With rsGenericName
        ...
        Set dtcGenaricName.RowSource = rsGenericName
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    If rsGeneric.State = 1 Then rsGeneric.Close: Set rsGeneric = Nothing
    If rsGenericName.State = 1 Then rsGenericName.Close: Set rsGenericName = Nothing
End Sub
