...
Begin VB.Form frmExpenceCategory 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Expence Category Names"
   ClientHeight    =   5220
   ClientLeft      =   1860
   ClientTop       =   1380
   ClientWidth     =   10665
   ...
   End
End
Attribute VB_Name = "frmExpenceCategory"
...
With rsViewCategory
    ...
    .Open "Select* From tblExpenceCatogery Order By ExpenceCatogery", cnnStores, adOpenStatic, adLockReadOnly
    If .RecordCount = 0 Then Exit Sub
    Set dtcCategoryName.RowSource = rsViewCategory
    dtcCategoryName.BoundColumn = "ExpenceCatogeryID"
    dtcCategoryName.ListField = "ExpenceCatogery"
End With
End Sub
...
On Error GoTo ErrorHandler
    ...
    If .State = 1 Then .Close
    .Open "Select * From tblExpenceCatogery Where (ExpenceCatogeryID = " & TemCategoryID & ")", cnnStores, 3, 3
 
    
    If .RecordCount = 0 Then Exit Sub
    
    !ExpenceCatogery = txtCategoryName.Text
...
On Error GoTo ErrorHandler
    ...
    If .State = 1 Then .Close
    .Open "Select * From tblExpenceCatogery", cnnStores, adOpenStatic, adLockOptimistic
...
With rsCategory
    ...
    If .State = 1 Then .Close
    .Open "Select tblExpenceCatogery.* From tblExpenceCatogery Where (ExpenceCatogeryID = " & dtcCategoryName.BoundText & ")", cnnStores, adOpenStatic, adLockReadOnly
   
    
    If .RecordCount = 0 Then Exit Sub
    Call ClearValues
    
    If Not (!ExpenceCatogery) = "" Then txtCategoryName.Text = !ExpenceCatogery
    If Not (!Comments) = "" Then txtComments.Text = !Comments
    TemCategoryID = !ExpenceCatogeryID
