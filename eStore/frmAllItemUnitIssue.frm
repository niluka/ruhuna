...
Begin VB.Form frmAllItemUnitIssue 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "All Item Issue to Units"
   ClientHeight    =   7770
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9780
   ...
   End
End
Attribute VB_Name = "frmAllItemUnitIssue"
...
Private Sub btnExcel_Click()
    GridToExcel GridIssue, "All Item Issue - " & dtcUnit.Text
End Sub
...
Private Function getSale(ItemID As Long) As Double

End Function

Private Function getReturn(ItemID As Long) As Double
...
'        temSql = "SELECT dbo.tblItem.ItemID, dbo.tblItem.Display " & _
'                        "ORDER BY dbo.tblItem.Display"
