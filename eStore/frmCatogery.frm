...
Begin VB.Form frmCatogery 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Catogery Names"
   ClientHeight    =   5505
   ClientLeft      =   2130
   ClientTop       =   1635
   ClientWidth     =   10920
...
On Error GoTo ErrorHandler
    ...
    .Open "Select tblItemCatogery.* From tblItemCatogery Where (ItemCategoryID = " & TemItemCategoryID & ")", cnnStores, adOpenStatic, adLockOptimistic
    
    If .RecordCount = 0 Then Exit Sub

    !ItemCatogery = Trim(txtCatogery.Text)
...
On Error GoTo ErrorHandler
    If .State = 1 Then .Close
    .Open "Select tblItemCatogery.* From tblItemCatogery", cnnStores, adOpenStatic, adLockOptimistic
...
With rsCatogery
    ...
    If .State = 1 Then .Close
    .Open "Select tblItemCatogery.* From tblItemCatogery Where (ItemCategoryID = " & dtcCatogeryName.BoundText & ")", cnnStores, adOpenStatic, adLockReadOnly

    
    If .RecordCount = 0 Then Exit Sub
    Call ClearValues
    txtCatogery.Text = !ItemCatogery
