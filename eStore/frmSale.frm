...
Begin VB.Form frmSale 
   ...
   Begin TabDlg.SSTab SSTab2 
      ...
      TabPicture(1)   =   "frmSale.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "frameStaff"
      Tab(1).Control(1)=   "frameOutPatient"
      Tab(1).Control(2)=   "frameInPatient"
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabCaption(1)   =   "Stocks"
      TabPicture(1)   =   "frmSale.frx":0070
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "GridTotal"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Usage"
      TabPicture(2)   =   "frmSale.frx":008C
      Tab(2).ControlEnabled=   0   'False
