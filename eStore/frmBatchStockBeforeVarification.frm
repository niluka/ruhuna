...
Begin VB.Form frmBatchStockBeforeVarification 
   ...
   End
End
Attribute VB_Name = "frmBatchStockBeforeVarification"
...
Private Sub FillGrid()
    ...
    With rsBatchStock
        ...
        temSelect = "SELECT tblItem.Display, tblBatch.Batch, tblBatch.DOE, tblBatchStock.Stock, tblCurrentPurchasePrice.PPrice,  tblCurrentPurchasePrice.PPrice*tblBatchStock.Stock AS StockValue"
...
Private Sub bttnPrint_Click()
    ...
    Select Case RetVal
        ...
        Case FORM_SELECTED   ' 1
            With dtrBatchStockBeforeVerification
                ...
                temTopic = "Batch Stock - Before Verification "
