...
Begin VB.Form frmAllItemCustomerIssue 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "All Item Issue For Customers"
   ClientHeight    =   7770
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9780
   ...
   End
End
Attribute VB_Name = "frmAllItemCustomerIssue"
...
Private Sub btnExcel_Click()
    GridToExcel GridIssue, "All Item Issue To Customers - " & dtcUnit.Text
End Sub
