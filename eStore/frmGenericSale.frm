...
Begin VB.Form frmGenericSale 
   ...
   Begin TabDlg.SSTab SSTab2 
      ...
      EndProperty
      TabCaption(0)   =   "Total"
      TabPicture(0)   =   "frmGenericSale.frx":0000
      ...
      TabPicture(1)   =   "frmGenericSale.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "frameStaff"
      Tab(1).Control(1)=   "frameCash"
      Tab(1).Control(2)=   "frameCredit"
      Tab(1).Control(3)=   "frameCheque"
      Tab(1).Control(4)=   "frameCreditCard"
      Tab(1).Control(5)=   "frameInPatient"
      Tab(1).Control(6)=   "frameOutPatient"
      Tab(1).ControlCount=   7
      TabCaption(2)   =   "Other"
      TabPicture(2)   =   "frmGenericSale.frx":0038
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      EndProperty
      TabCaption(0)   =   "Item"
      TabPicture(0)   =   "frmGenericSale.frx":0054
      Tab(0).ControlEnabled=   -1  'True
      ...
      TabCaption(1)   =   "Stocks"
      TabPicture(1)   =   "frmGenericSale.frx":0070
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "GridTotal"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Usage"
      TabPicture(2)   =   "frmGenericSale.frx":008C
      Tab(2).ControlEnabled=   0   'False
      ...
      TabPicture(3)   =   "frmGenericSale.frx":00A8
      ...
      TabCaption(4)   =   "Prices"
      TabPicture(4)   =   "frmGenericSale.frx":00C4
      ...
      TabPicture(5)   =   "frmGenericSale.frx":00E0
   ...
   End
End
Attribute VB_Name = "frmGenericSale"
...
Option Explicit
    ...
    Dim rsViewGeneric As New ADODB.Recordset
...
Private Sub dtcGeneric_Change()
    If IsNumeric(dtcGeneric.BoundText) Then
        ListSelectedGeneric
    Else
        ListAllItems
    End If
...
Private Sub ListSelectedGeneric()
With rsItem
    If .State = 1 Then .Close
    temSql = "SELECT * from tblitem where GenericNameID = " & dtcGeneric.BoundText & " order by display"
    .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
End With
With dtcItem
    Set .RowSource = rsItem
...
With rsCode
    If .State = 1 Then .Close
    temSql = "SELECT * from tblitem where GenericNameID = " & dtcGeneric.BoundText & " order by code"
    .Open temSql, cnnStores, adOpenStatic, adLockReadOnly
End With
With dtcCode
    Set .RowSource = rsCode
...
Private Sub dtcGeneric_KeyDown(KeyCode As Integer, Shift As Integer)
