...
Begin VB.Form frmDisplayPurchaseCancellation 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Display Purchase"
   ClientHeight    =   9810
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   15585
   ...
   End
End
Attribute VB_Name = "frmDisplayPurchaseCancellation"
...
Private Sub GetValues()
    With rsTemRefillBill
        temSQL = "SELECT tblRefillBill.Date,  tblRefillBill.PaymentMethodID,tblRefillBill.Time, tblRefillBill.RefillBillID, tblDistrubutor.DistributorName, tblDistrubutor.DistributorID, tblStaffReceivedBy.Name, tblStaffCheckedBy.Name, tblRefillBill.Price, tblRefillBill.Discount, tblRefillBill.NetPrice " & _
