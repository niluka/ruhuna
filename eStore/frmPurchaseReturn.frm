...
Begin VB.Form frmPurchaseReturn 
   ...
   Begin TabDlg.SSTab SSTab2 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Return"
      TabPicture(0)   =   "frmPurchaseReturn.frx":0000
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Label59"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "Label58"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "Label55"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "Label60"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "frameCredit"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "frameCheque"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "frameCreditCard"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "frameCash"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "dtcRPayment"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "txtRTotal"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "txtRDiscount"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "txtNReturn"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).ControlCount=   12
      TabCaption(1)   =   "Purchase"
      TabPicture(1)   =   "frmPurchaseReturn.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Label23"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "lblGrossTotal"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).Control(2)=   "lblNetTotal"
      ...
      Tab(1).Control(6)=   "lblDate"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "lblTime"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "Label63"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "lblTime1"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "dtcPayment"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "txtDiscount"
      Tab(1).Control(11).Enabled=   0   'False
      Tab(1).Control(12)=   "txtDiscountPercent"
      Tab(1).Control(12).Enabled=   0   'False
      Tab(1).ControlCount=   13
      TabCaption(2)   =   "Other"
      TabPicture(2)   =   "frmPurchaseReturn.frx":0038
      ...
      Tab(2).Control(6)=   "Label53"
      Tab(2).Control(6).Enabled=   0   'False
      Tab(2).Control(7)=   "dtcRCStaff"
      Tab(2).Control(7).Enabled=   0   'False
      Tab(2).Control(8)=   "dtcStore"
      Tab(2).Control(8).Enabled=   0   'False
      Tab(2).Control(9)=   "dtcRStaff"
      Tab(2).Control(9).Enabled=   0   'False
      Tab(2).Control(10)=   "dtcSupplier"
      Tab(2).Control(10).Enabled=   0   'False
      Tab(2).Control(11)=   "dtcStaff"
      Tab(2).Control(11).Enabled=   0   'False
      Tab(2).Control(12)=   "dtcChecked"
      Tab(2).Control(12).Enabled=   0   'False
      Tab(2).Control(13)=   "txtInvoice"
      Tab(2).Control(13).Enabled=   0   'False
      Tab(2).ControlCount=   14
      Begin VB.TextBox txtNReturn 
         Alignment       =   1  'Right Justify
         Height          =   375
         Left            =   -72360
         TabIndex        =   142
      ...
      Begin MSDataListLib.DataCombo dtcSupplier 
         ...
         Text            =   ""
      End
      Begin MSDataListLib.DataCombo dtcRStaff 
         Height          =   360
         Left            =   2400
         TabIndex        =   120
         Top             =   3120
         ...
         Text            =   ""
      End
      Begin MSDataListLib.DataCombo dtcStore 
         Height          =   360
         Left            =   2400
         TabIndex        =   122
         Top             =   2400
         ...
         Text            =   ""
      End
      Begin MSDataListLib.DataCombo dtcRCStaff 
         Height          =   360
         Left            =   2400
         TabIndex        =   124
         Top             =   3600
      ...
      Begin MSDataListLib.DataCombo dtcPayment 
         ...
         Text            =   ""
      End
      Begin MSDataListLib.DataCombo dtcRPayment 
         Height          =   360
         Left            =   -72360
         TabIndex        =   134
         Top             =   1920
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Item"
      TabPicture(0)   =   "frmPurchaseReturn.frx":0054
      Tab(0).ControlEnabled=   0   'False
      ...
      TabCaption(1)   =   "Stocks"
      TabPicture(1)   =   "frmPurchaseReturn.frx":0070
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "GridTotal"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Usage"
      TabPicture(2)   =   "frmPurchaseReturn.frx":008C
      ...
      TabPicture(3)   =   "frmPurchaseReturn.frx":00A8
      ...
      TabCaption(4)   =   "Prices"
      TabPicture(4)   =   "frmPurchaseReturn.frx":00C4
      ...
      TabPicture(5)   =   "frmPurchaseReturn.frx":00E0
...
Private Sub FillGrid()
    With rsTemRefillBill
        ...
        temSQL = "SELECT * FROM tblRefillBIll where RefillBillID = " & TxRefillBillID
        .Open temSQL, cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            dtcSupplier.BoundText = !DistributorID
            dtcStore.BoundText = !StoreID
            dtcStaff.BoundText = !StaffID
            dtcChecked.BoundText = !CheckedStaffID
            lblGrossTotal.Caption = Format(!Price, "0.00")
            ...
            dtcPayment.BoundText = !PaymentMethodID
        End If
        .Close
    End With
    With rsTemRefill
