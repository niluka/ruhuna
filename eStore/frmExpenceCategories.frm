...
Begin VB.Form frmExpenceCategories 
   ...
   End
End
Attribute VB_Name = "frmExpenceCategories"
...
Private Sub FillCategoryName()
    With rsViewCategory
        ...
        .Open "Select* From tblExpenceCategory Order By ExpenceCategory", cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            Set dtcCategoryName.RowSource = rsViewCategory
            dtcCategoryName.BoundColumn = "ExpenceCategoryID"
            dtcCategoryName.ListField = "ExpenceCategory"
        End If
    End With
End Sub
...
Private Sub bttnChange_Click()
    ...
    On Error Resume Next
        If .State = 1 Then .Close
        .Open "Select * From tblExpenceCategory Where (ExpenceCategoryID = " & TemCategoryID & ")", cnnStores, 3, 3
        If .RecordCount > 0 Then
            !ExpenceCategory = txtCategoryName.Text
...
Private Sub bttnSave_Click()
    ...
    On Error Resume Next
        If .State = 1 Then .Close
        .Open "Select * From tblExpenceCategory", cnnStores, adOpenStatic, adLockOptimistic
        .AddNew
        !ExpenceCategory = txtCategoryName.Text
        !Comments = txtComments.Text
        .Update
...
Private Sub DisplaySelected()
    ...
    With rsCategory
        If .State = 1 Then .Close
        .Open "Select tblExpenceCategory.* From tblExpenceCategory Where (ExpenceCategoryID = " & dtcCategoryName.BoundText & ")", cnnStores, adOpenStatic, adLockReadOnly
        If .RecordCount > 0 Then
            Call ClearValues
            If Not (!ExpenceCategory) = "" Then txtCategoryName.Text = !ExpenceCategory
            If Not (!Comments) = "" Then txtComments.Text = !Comments
            TemCategoryID = !ExpenceCategoryID
        Else
            Call ClearValues
            txtCategoryName.Text = Empty
            txtComments.Text = Empty
