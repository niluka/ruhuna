...
Begin VB.Form frmSaleCancellations 
   ...
   End
End
Attribute VB_Name = "frmSaleCancellations"
...
Private Sub bttnUpdate_Click()
    ...
    tr = MsgBox("Are you sure you want to cancel this bill?", vbYesNo, "Cancel")
    ...
    With rsSaleBill
        ...
        If .RecordCount > 0 Then
            ...
            !CancelledCUserID = UserID
            !CancelledValue = Val(txtReturnValue.Text)
            TemCost = !NetCost
    ...
    With GridItem
        ...
        For i = 1 To .Rows - 1
            ...
            rsReturn!ReturnRate = .TextMatrix(i, 9)
            rsReturn!ReturnAmount = .TextMatrix(i, 11)
            rsReturn!ReturnPrice = .TextMatrix(i, 12)
            rsReturn!Cost = Val(.TextMatrix(i, 14))
            rsReturn.Update
    ...
    ElseIf dtcRepaymentMethod.Text = "Credit" Then
        With rsIssuedCash
            ...
            ElseIf lblCustomer.Caption = "Indoor Patient" Then
                ...
                End With
            ElseIf lblCustomer.Caption = "Staff Customer" Then
                !IssuedSTaffID = txtCustomerID.Text
                With rsTemCustomer
                    If .State = 1 Then .Close
    ...
    ElseIf dtcRepaymentMethod.Text = "Credit Card" Then
        ...
        With rsReturnBill
            ...
            .Open temSql, cnnStores, adOpenStatic, adLockOptimistic
            If .RecordCount > 0 Then
                !IssuedCreditCardID = temIssueCreditCardID
                .Update
            End If
            .Close
        End With
    ...
    MsgBox "Successfully Cancelled the bill"
    With frmBillSearchForCancellations
        .Show
        .ZOrder 0
        .Top = 0
        .Left = 0
