...
Begin VB.Form frmAutoOrderingNew 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Usage"
      TabPicture(0)   =   "frmAutoOrderingNew.frx":0000
      ...
      TabPicture(1)   =   "frmAutoOrderingNew.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Frame3"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Items"
      TabPicture(2)   =   "frmAutoOrderingNew.frx":0038
      Tab(2).ControlEnabled=   -1  'True
      Tab(2).Control(0)=   "Frame4"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "Order For"
      TabPicture(3)   =   "frmAutoOrderingNew.frx":0054
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "Frame2"
      Tab(3).Control(1)=   "mvOrderTo"
      Tab(3).Control(2)=   "mvOrderFrom"
      Tab(3).Control(3)=   "Label5"
      Tab(3).Control(4)=   "Label4"
      Tab(3).ControlCount=   5
      TabCaption(4)   =   "Other"
      TabPicture(4)   =   "frmAutoOrderingNew.frx":0070
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "Frame5"
      Tab(4).Control(1)=   "chkIgnoreOrdersPending"
      ...
      Begin VB.Frame Frame4 
         ...
         Top             =   360
         Width           =   8655
         Begin VB.Frame FrameSelectItems 
            ...
            End
         End
         Begin VB.Frame FrameListCategories 
            ...
            Begin MSDataListLib.DataCombo dtcICatogery 
               ...
               Text            =   ""
            End
            Begin VB.OptionButton optDistributor 
               Caption         =   "Distributor"
               Height          =   255
               Left            =   120
               TabIndex        =   48
   ...
   End
End
Attribute VB_Name = "frmAutoOrderingNew"
...
Private Sub btnNone_Click()
    ...
    For i = 0 To lstSelectedItem.ListCount - 1
        lstSelectedItem.Selected(i) = True
        lstSelectedItemID.Selected(i) = True
    Next
    bttnRemoveItem_Click
End Sub
            ...
            With rsTemOrders
                ...
                If .RecordCount < 1 Or chkIgnoreOrdersPending.Value = 1 Then
                    ...
                    If TotalRequest <> 0 Then
                        ...
                        End If
                        If TotalRequest Mod NewItem.IssueUnitsPerPack <> 0 Then
                            TotalRequest = ((TotalRequest \ NewItem.IssueUnitsPerPack) * NewItem.IssueUnitsPerPack) + NewItem.IssueUnitsPerPack
                        End If
                    End If
...
Dim i As Integer
For i = lstSelectedItem.ListCount - 1 To 0 Step -1
...
Private Sub ListSelectedDistributorItems()
...
Private Sub dtcDistributor_Change()
    If optDistributor.Value = True Then
        If IsNumeric(dtcDistributor.BoundText) = True Then
            Call ListSelectedDistributorItems
        Else
            Call ListAllItems
        End If
    End If
...
Private Sub dtcICatogery_Change()
    If optCategory.Value = True Then
        If IsNumeric(dtcICatogery.BoundText) = True Then
...
Private Sub Form_Load()
    ...
    chkIgnoreOrdersPending.Value = 1
End Sub
...
Private Sub GetSettings()
    ...
    optCategory.Value = GetSetting(App.EXEName, "Options", "optCategory", False)
    optDistributor.Value = GetSetting(App.EXEName, "Options", "optDistributor", False)
    chkIgnoreOrdersPending.Value = 1 ' GetSetting(App.EXEName, "Options", "chkIgnoreOrdersPending", 1)
...
Private Sub SaveSettings()
    ...
    SaveSetting App.EXEName, "Options", "optCategory", optCategory.Value
    SaveSetting App.EXEName, "Options", "optDistributor", optDistributor.Value
    SaveSetting App.EXEName, "Options", "chkIgnoreOrdersPending", 1 'chkIgnoreOrdersPending.Value
...
Private Sub OptAllItems_Click()
    If optAllItems.Value = True Then
        ...
        dtcICatogery.Text = Empty
        FrameListCategories.Enabled = False
        FrameSelectItems.Enabled = False
    Else
        FrameListCategories.Enabled = True
        FrameSelectItems.Enabled = True
    End If
End Sub
...
Private Sub optCategory_Click()
    dtcICatogery.Enabled = True
    dtcDistributor.Enabled = False
    dtcDistributor.Text = Empty
End Sub

Private Sub optDistributor_Click()
    dtcICatogery.Text = Empty
    dtcICatogery.Enabled = False
